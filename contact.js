...
.ct-card{background:#F3F0E8;border:1px solid rgba(24,26,28,0.12);border-radius:14px;padding:clamp(24px,3vw,40px)}
...
.ct-req{color:#047857}
.ct-input,.ct-select,.ct-textarea{display:block;width:100%;min-height:52px;border:1px solid rgba(24,26,28,0.22);border-radius:10px;background:#F3F0E8;color:#3A403A;font-family:inherit;font-size:16px;line-height:1.5;padding:14px 15px;outline:none;transition:border-color .16s,box-shadow .16s}
...
.ct-btn2--outline{background:transparent;color:#3A403A;border:1.5px solid rgba(40,39,38,.35)}
