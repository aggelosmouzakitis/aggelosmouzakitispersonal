...
var INTERESTS = [{
  value: 'orientation',
  label: 'Free orientation call (1:1 work)'
}, {
  value: 'wtf-friday',
  label: 'WTF Friday (free group office hours)'
}, {
  value: 'other',
...
function ContactForm() {
  ...
  e('div', {
    ...
    id: 'interest-help',
    className: 'ct-help'
  }, 'Choose the orientation call if you want to work together on something specific.')),
  // Message
  e('div', {
    className: 'ct-field'
  }, e('label', {
