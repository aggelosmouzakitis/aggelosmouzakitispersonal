...
function StartHereStyles() {
  ...
  // card grid (Step 1)
  '.sh-grid{display:grid;grid-template-columns:1fr 1fr;gap:20px}', '.sh-card{position:relative;display:flex;flex-direction:column;min-height:176px;text-align:left;background:#FFFFFF;border:1.5px solid rgba(24,26,28,.16);border-radius:8px;padding:24px 28px 26px;cursor:pointer;font-family:inherit;color:#181A1C;box-shadow:5px 5px 0 rgba(4,120,87,.18);transition:transform .13s ease,box-shadow .13s ease,border-color .13s ease}', '.sh-card:hover{border-color:rgba(24,26,28,.30);transform:translate(-2px,-2px);box-shadow:7px 7px 0 rgba(4,120,87,.26)}', '.sh-card:focus-visible{outline:2px solid #047857;outline-offset:3px}', '.sh-card.is-sel{border-color:#047857;box-shadow:5px 5px 0 rgba(4,120,87,.34)}', '.sh-card.is-pressing{border-color:#047857;transform:translate(5px,5px);box-shadow:0 0 0 rgba(4,120,87,0)}', '.sh-card__top{display:flex;align-items:center;justify-content:space-between;margin-bottom:clamp(26px,3.2vw,40px)}', '.sh-card__num{font-family:var(--font-heading);font-size:17px;font-weight:800;letter-spacing:.02em;color:#181A1C;font-variant-numeric:tabular-nums}', '.sh-card.is-sel .sh-card__num,.sh-card.is-pressing .sh-card__num{color:#047857}', '.sh-card__arrow{font-size:20px;line-height:1;color:#181A1C;transition:transform .15s,color .15s}', '.sh-card:hover .sh-card__arrow{transform:translateX(3px)}', '.sh-card.is-sel .sh-card__arrow,.sh-card.is-pressing .sh-card__arrow{color:#047857}', '.sh-card__copy{font-size:clamp(20px,1.55vw,24px);line-height:1.28;font-weight:500;letter-spacing:-.01em;color:#181A1C}',
  // list rows (Flow A offers, Flow C tools)
  '.sh-list{display:flex;flex-direction:column;margin-top:4px}', '.sh-row{display:flex;align-items:center;justify-content:space-between;gap:24px;padding:22px 4px;border-top:1px solid rgba(24,26,28,.16);color:#181A1C;text-decoration:none;transition:color .15s,border-color .15s,padding-left .15s}', '.sh-row:last-child{border-bottom:1px solid rgba(24,26,28,.16)}', '.sh-row:hover{color:#047857;border-top-color:#047857;padding-left:12px}', '.sh-row:focus-visible{outline:2px solid #047857;outline-offset:3px}', '.sh-row__main{min-width:0;display:flex;flex-direction:column;gap:6px}', '.sh-row__title{font-family:var(--font-heading);font-size:clamp(20px,1.5vw,24px);font-weight:600;line-height:1.22;letter-spacing:-.01em;color:inherit}', '.sh-row__desc{font-size:15px;line-height:1.5;color:#5E6264}', '.sh-row__go{flex:none;display:inline-flex;align-items:center;gap:8px;font-size:13px;font-weight:700;letter-spacing:.06em;text-transform:uppercase;color:#047857;white-space:nowrap}', '.sh-row__arrow{flex:none;font-size:20px;line-height:1;color:#047857}',
  // outcome layout (Flow B orientation, Flow D wtf)
  '.sh-outcome{display:grid;grid-template-columns:7fr 5fr;gap:44px;align-items:start}', '.sh-outcome__lead{min-width:0}', '.sh-outcome__body{font-size:18px;line-height:1.6;color:#282726;margin:0;max-width:60ch}', '.sh-panel{background:#FFFFFF;border:1.5px solid rgba(24,26,28,.20);border-radius:8px;padding:26px 24px}', '.sh-btn{display:inline-flex;align-items:center;justify-content:center;width:100%;min-height:54px;padding:0 20px;background:#047857;color:#fff;font-family:inherit;font-weight:700;font-size:13px;letter-spacing:.05em;text-transform:uppercase;line-height:1.25;text-align:center;border:1.5px solid #047857;border-radius:0;text-decoration:none;cursor:pointer;transition:filter .16s}', '.sh-btn:hover{filter:brightness(.93)}', '.sh-btn:focus-visible{outline:2px solid #047857;outline-offset:3px}', '.sh-btn--ghost{background:transparent;color:#181A1C;border-color:rgba(24,26,28,.30)}', '.sh-btn--ghost:hover{filter:none;border-color:#181A1C}', '.sh-btn + .sh-btn{margin-top:12px}', '.sh-note{font-size:13px;line-height:1.5;color:#5E6264;margin:10px 0 0}', '.sh-panel__group + .sh-panel__group{margin-top:16px;padding-top:16px;border-top:1px solid rgba(24,26,28,.12)}',
  // quiet text links (fallbacks, lower-emphasis options, Step 1 ask route)
  '.sh-fallbacks{margin-top:30px;display:flex;flex-direction:column;gap:14px;align-items:flex-start}', '.sh-textlink{background:none;border:0;padding:2px 0;font-family:inherit;font-size:15px;line-height:1.5;color:#282726;cursor:pointer;text-align:left;text-decoration:none;transition:color .15s}', '.sh-textlink:hover{color:#047857}', '.sh-textlink:focus-visible{outline:2px solid #047857;outline-offset:3px}', '.sh-textlink--low{font-size:14px;color:#5E6264}',
  // quiet controls
  '.sh-controls{display:flex;flex-wrap:wrap;gap:24px;align-items:center;margin-top:40px}', '.sh-quiet{background:none;border:0;padding:6px 0;font-family:inherit;font-size:12px;font-weight:700;letter-spacing:.12em;text-transform:uppercase;color:#8A8A8A;cursor:pointer;transition:color .15s}', '.sh-quiet:hover{color:#181A1C}', '.sh-quiet:focus-visible{outline:2px solid #047857;outline-offset:3px}',
  // responsive
