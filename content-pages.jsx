  ...
  return React.createElement('main', { style: mainStyle },
    ...
    React.createElement('div', { style: introRowStyle },
      ...
      React.createElement('div', { style: introImgWrapStyle },
        ...
        React.createElement('div', { style: { display: mob ? 'none' : 'flex', alignItems: 'center', justifyContent: 'flex-end', gap: '6px', marginTop: '12px', paddingRight: '10px' } },
          React.createElement('span', { style: { fontFamily: "'Segoe Script','Bradley Hand','Comic Sans MS',cursive", fontStyle: 'italic', fontSize: '16px', color: C.accent, transform: 'rotate(-3deg)', whiteSpace: 'nowrap' } }, 'Friendlier than I look'),
          React.createElement('svg', { width: 40, height: 34, viewBox: '0 0 40 34', fill: 'none', stroke: C.accent, strokeWidth: 1.7, strokeLinecap: 'round', strokeLinejoin: 'round' },
            React.createElement('path', { d: 'M4 32 C 4 16, 16 8, 34 6' }),
            React.createElement('path', { d: 'M26 4 L35 5 L32 13' })
          )
        )
      )
    ),
...
function SolopreneursPage() {
  ...
  return React.createElement('main', { style: mobPage },
    ...
    React.createElement(Section, { label: 'What you came here for', mob },
      React.createElement(P, null, "You came here about the business. Typical things I've heard so far include things you avoid, things you are overthinking, things you are afraid of, lack of focus, procrastination and more. The common thread is that they start inside you but get spilled into your business."),
      React.createElement(P, { last: true },
    ...
    React.createElement(Section, { label: 'So what we actually do', mob },
      ...
      React.createElement(P, null, React.createElement(Strong, null, "The business track."), " The decision in front of you, the offer, the pricing, the move you need to make, the plan for where you're going. Real, practical, strategic."),
    ...
    React.createElement('hr', { style: sepStyle }),
    React.createElement(Section, { label: 'Who this is for', mob },
      React.createElement(P, null, "Solopreneurs and independent consultants in tech, ideally in Europe, the US or Canada, mostly for timezones."),
