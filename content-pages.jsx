...
const FOOTER_COLS_BY_LANG = {
  en: [
    ...
    { label: 'Site', links: [
      ...
      { href: '/burnout-diagnostic/', label: 'Burnout Diagnostic' },
...
const FOOTER_COPYLINE = { en: '© Aggelos Mouzakitis · Business Advisor + Therapist', el: '© Άγγελος Μουζακίτης · Σύμβουλος επιχειρήσεων & ψυχικής υγείας' };
...
const HOME = {
  en: {
    ...
    ce: [
      { cause: 'You avoid being seen', effect: 'not enough people know you exist' },
      { cause: 'A "no" feels too personal', effect: 'you avoid selling' },
      { cause: "You're uncomfortable asking for money", effect: 'you underprice' },
      { cause: "You don't trust your own judgment", effect: 'you keep changing direction' },
      { cause: 'You need certainty before acting', effect: 'you prepare instead of launching' },
      { cause: 'You overthink decisions', effect: 'the business moves slowly' },
      { cause: 'You need everyone to like you', effect: 'your boundaries get commercially expensive' },
    ],
    ...
    tt: [
      { title: 'The business track', body: 'Offer, positioning, pricing, acquisition, sales, experiments, priorities, decisions, execution. The question it answers: what does the business actually need next?' },
      { title: 'The person building it', body: 'Avoidance, visibility, rejection, perfectionism, money, self-doubt, control, identity, uncertainty, commitment. The question it answers: what in you affects whether you can actually do it?' },
    ],
    ...
    who: [
      'have a job and want to build your way out',
      'like your job but want optionality',
      'want an independent income stream',
      'want a portfolio career instead of one employer',
      'have expertise you think could become a business',
      'already freelance or consult',
      "have something working, and know there's substantially more growth in it",
    ],
    ...
    faq: [
      { q: 'Do I need to already have a business?', a: "No. Existing revenue isn't a requirement — this is for people seriously trying to build, whether you're still employed and planning an exit, freelancing, or already running something small." },
      { q: 'What kind of people is this for?', a: 'People building something of their own: employed and planning a way out, wanting optionality or independent income, a portfolio career, expertise to turn into a business, already freelancing or consulting, or running something with much more growth left in it.' },
      { q: 'Is this therapy or business advisory?', a: "Both, on purpose. Some of what's in the way is a real business problem; some is a pattern in you. I work on either without you having to pick a lane first." },
      { q: "What if I don't know whether my problem is strategic or psychological?", a: "That's normal — and often the first thing we work out together. Frequently it turns out to be both." },
      { q: 'Can we work on practical things — offer, pricing, sales, acquisition?', a: "Yes. That's the business track, and it's real advisory on the thing you're building — not “clarity” or “accountability”." },
      { q: 'Do I need to want to leave my job?', a: 'No. Some people want an exit; others just want optionality or an independent income alongside a job they like.' },
    ],
  },
  el: {
    ...
    ce: [
      { cause: 'Αποφεύγεις να σε δουν', effect: 'λίγοι ξέρουν ότι υπάρχεις' },
      { cause: 'Ένα «όχι» το παίρνεις προσωπικά', effect: 'σταματάς να πουλάς' },
      { cause: 'Σε δυσκολεύει να ζητήσεις χρήματα', effect: 'υποτιμολογείς' },
      { cause: 'Δεν εμπιστεύεσαι την κρίση σου', effect: 'αλλάζεις συνεχώς κατεύθυνση' },
      { cause: 'Θέλεις βεβαιότητα πριν κινηθείς', effect: 'προετοιμάζεσαι αντί να ξεκινήσεις' },
      { cause: 'Σκέφτεσαι υπερβολικά κάθε απόφαση', effect: 'η επιχείρηση κινείται αργά' },
      { cause: 'Θέλεις να σε συμπαθούν όλοι', effect: 'τα όριά σου κοστίζουν εμπορικά' },
    ],
    ...
    tt: [
      { title: 'Το επιχειρηματικό επίπεδο', body: 'Προσφορά, positioning, τιμολόγηση, εύρεση πελατών, πωλήσεις, πειράματα, προτεραιότητες, αποφάσεις, εκτέλεση. Το ερώτημα: τι χρειάζεται πραγματικά η επιχείρηση μετά;' },
      { title: 'Ο άνθρωπος που τη χτίζει', body: 'Αποφυγή, ορατότητα, απόρριψη, τελειομανία, χρήμα, αυτοαμφισβήτηση, έλεγχος, ταυτότητα, αβεβαιότητα, δέσμευση. Το ερώτημα: τι μέσα σου επηρεάζει το αν μπορείς πραγματικά να το κάνεις;' },
    ],
    ...
    who: [
      'έχεις δουλειά και θέλεις να χτίσεις την έξοδό σου',
      'σου αρέσει η δουλειά σου αλλά θέλεις εναλλακτικές',
      'θέλεις ένα ανεξάρτητο εισόδημα',
      'θέλεις μια portfolio καριέρα αντί για έναν εργοδότη',
      'έχεις μια εξειδίκευση που πιστεύεις ότι μπορεί να γίνει επιχείρηση',
      'ήδη δουλεύεις ανεξάρτητα ή ως σύμβουλος',
      'έχεις κάτι που δουλεύει, και ξέρεις ότι υπάρχει πολύ περισσότερη ανάπτυξη μέσα του',
    ],
    ...
    faq: [
      { q: 'Χρειάζεται να έχω ήδη επιχείρηση;', a: 'Όχι. Δεν χρειάζεται να έχεις έσοδα — είναι για ανθρώπους που προσπαθούν σοβαρά να χτίσουν κάτι, είτε είσαι ακόμη μισθωτός και σχεδιάζεις έξοδο, είτε δουλεύεις ανεξάρτητα, είτε τρέχεις ήδη κάτι μικρό.' },
      { q: 'Για ποιους ανθρώπους είναι;', a: 'Για ανθρώπους που χτίζουν κάτι δικό τους: μισθωτούς που σχεδιάζουν έξοδο, όσους θέλουν εναλλακτικές ή ανεξάρτητο εισόδημα, μια portfolio καριέρα, μια εξειδίκευση που μπορεί να γίνει επιχείρηση, ήδη freelancers, ή κάποιον που τρέχει κάτι με πολλή ανάπτυξη ακόμη μέσα του.' },
      { q: 'Είναι θεραπεία ή συμβουλευτική επιχειρήσεων;', a: 'Και τα δύο, σκόπιμα. Ένα μέρος του εμποδίου είναι πραγματικό επιχειρηματικό πρόβλημα· ένα μέρος είναι μοτίβο μέσα σου. Δουλεύω και τα δύο χωρίς να χρειάζεται να διαλέξεις.' },
      { q: 'Κι αν δεν ξέρω αν το πρόβλημά μου είναι στρατηγικό ή ψυχολογικό;', a: 'Είναι φυσιολογικό — και συχνά το πρώτο που ξεκαθαρίζουμε μαζί. Πολλές φορές είναι και τα δύο.' },
      { q: 'Μπορούμε να δουλέψουμε πρακτικά πράγματα — προσφορά, τιμολόγηση, πωλήσεις;', a: 'Ναι. Αυτό είναι το επιχειρηματικό επίπεδο, πραγματική συμβουλευτική για αυτό που χτίζεις — όχι «καθαρότητα» ή «λογοδοσία».' },
      { q: 'Πρέπει να θέλω να αφήσω τη δουλειά μου;', a: 'Όχι. Κάποιοι θέλουν έξοδο· άλλοι απλώς εναλλακτικές ή ανεξάρτητο εισόδημα παράλληλα με μια δουλειά που τους αρέσει.' },
    ],
  },
};
...
function HomePage({ lang = 'en' }) {
  ...
  const introTextStyle = mob ? { width: '100%' } : { flex: '1.15 1 0', minWidth: 0, maxWidth: 540 };
  ...
  return React.createElement('main', { style: mainStyle },
    ...
    React.createElement('div', { style: introRowStyle },
      React.createElement('div', { style: introTextStyle },
        React.createElement('div', { style: { fontSize: '12px', fontWeight: 700, letterSpacing: '.16em', textTransform: 'uppercase', color: C.accent, marginBottom: '1rem' } }, u.role),
        React.createElement('h1', { style: { fontSize: mob ? '26px' : '34px', fontWeight: 500, lineHeight: 1.25, letterSpacing: '-.02em', color: C.text, margin: '0 0 1rem' } }, c.promise),
        React.createElement('p', { style: { fontSize: mob ? '17px' : '19px', fontWeight: 600, color: C.accent, margin: '0 0 1.4rem', lineHeight: 1.4 } }, c.tagline),
        React.createElement(P, null, c.introA),
        React.createElement(P, { last: true }, c.introB),
    ...
    React.createElement('div', { style: { marginTop: mob ? '3.25rem' : '5rem' } }),
    ...
    React.createElement(Section, { label: c.ceLabel, mob },
      React.createElement(P, { last: true }, c.ceLead),
      React.createElement('div', { style: { marginTop: '1.1rem' } }, React.createElement(PatternList, { items: c.ce.slice(0, 5) }))
    ),
    ...
    React.createElement(Section, { label: c.ttLabel, mob },
      React.createElement('div', { style: { margin: '0 0 1.2rem' } },
        React.createElement(TrackCards, { mob, tracks: c.tt })
      ),
      React.createElement('p', { style: { fontSize: mob ? '17px' : '18px', fontWeight: 600, color: C.text, margin: '0 0 .5rem', lineHeight: 1.6 } }, c.ttCore),
      React.createElement('p', { style: { fontSize: '15px', lineHeight: 1.6, color: C.muted, margin: 0 } }, c.ttNote)
    ),

    React.createElement('hr', { style: sepStyle }),

    // ── One offer ──
    React.createElement(Section, { label: c.offerLabel, mob },
      React.createElement(P, null, c.offerBody),
      React.createElement('p', { style: { margin: 0 } }, React.createElement(IA, { href: pathFor('one-to-one', lang) }, c.offerLink))
    ),

    React.createElement('hr', { style: sepStyle }),

    // ── FAQ (secondary info, progressively disclosed) ──
    React.createElement(Section, { label: c.faqLabel, mob },
...
const ONE = {
  en: {
    ...
    tracks: [
      { title: 'Business', body: 'Offer, positioning, pricing, acquisition, sales, prioritisation, decisions, execution. Real advisory on the thing you’re building — not "clarity" or "accountability".' },
      { title: 'The person', body: 'Whatever psychological pattern is materially affecting progress — avoidance, visibility, charging, self-doubt, control, commitment. Worked in terms of how it hits the business, not as generic mental health.' },
    ],
    ...
    steps: [
      { n: '1', title: 'Fit call', tag: '~15 min · free', body: 'A short call to see if we click and whether I’m the right person for what you’re trying to build. Not a session.' },
      { n: '2', title: 'First paid session', tag: 'one session', body: 'You bring the problem as you see it. We find the more accurate one underneath, and you leave with a clear read and one real move — worth it even if we stop there.' },
      { n: '3', title: 'Ongoing', tag: 'if it’s worth it', body: 'Private, 1:1, online. Weekly at first so the work compounds, then flexible. It continues only as long as it’s genuinely useful.' },
    ],
    ...
    not: [
      'Not conventional business coaching — there’s no framework I hand you to run.',
      'Not generic mindset or confidence coaching.',
      'Not psychotherapy detached from the business.',
    ],
    ...
    faqLabel: 'Common questions',
    faq: [
      { q: 'Do I need to already have a business?', a: "No. Existing revenue isn't a requirement — this is for people seriously trying to build, employed or independent, whether you're planning an exit, freelancing, or already running something small." },
      { q: 'Is this therapy?', a: "It's therapy-informed and I'm a BACP-registered therapist, but it's not therapy by the protocol — more direct and action-oriented, and always tied to what you're building." },
      { q: 'Is this business coaching?', a: "There's advisory in it, but no framework I hand you to run. It's real work on the offer, the pricing, the decision in front of you." },
      { q: 'What kinds of business problems can we work on?', a: 'Offer, positioning, pricing, acquisition, sales, prioritisation, decisions, execution — the practical work of building the thing.' },
      { q: 'What if the problem turns out not to be psychological?', a: 'Then we treat it as the business problem it is. Not everything is a pattern — sometimes the offer is just weak, or the pricing is wrong, and we fix that.' },
      { q: 'How do we decide whether to focus on the business or the person?', a: "Week to week, by what's actually blocking progress. Some weeks it's 90% business; some weeks the business barely comes up because something in you is the real blocker." },
      { q: 'Is this only for people leaving employment?', a: "No — employed, independent, or already running something. What's common is that you're seriously trying to build." },
    ],
  },
  el: {
    ...
    tracks: [
      { title: 'Επιχείρηση', body: 'Προσφορά, positioning, τιμολόγηση, εύρεση πελατών, πωλήσεις, προτεραιότητες, αποφάσεις, εκτέλεση. Πραγματική συμβουλευτική για αυτό που χτίζεις — όχι «καθαρότητα» ή «λογοδοσία».' },
      { title: 'Ο άνθρωπος', body: 'Όποιο ψυχολογικό μοτίβο επηρεάζει ουσιαστικά την πρόοδο — αποφυγή, ορατότητα, χρέωση, αυτοαμφισβήτηση, έλεγχος, δέσμευση. Δουλεύεται ως προς το πώς χτυπά την επιχείρηση, όχι ως γενική ψυχική υγεία.' },
    ],
    ...
    steps: [
      { n: '1', title: 'Γνωριμία', tag: '~15 λεπτά · δωρεάν', body: 'Μια σύντομη κλήση για να δούμε αν ταιριάζουμε και αν είμαι ο σωστός άνθρωπος για αυτό που χτίζεις. Δεν είναι συνεδρία.' },
      { n: '2', title: 'Πρώτη συνεδρία', tag: 'μία συνεδρία', body: 'Φέρνεις το πρόβλημα όπως το βλέπεις. Βρίσκουμε το πιο ακριβές από κάτω, και φεύγεις με μια καθαρή εικόνα και μία πραγματική κίνηση — αξίζει ακόμη κι αν σταματήσουμε εκεί.' },
      { n: '3', title: 'Συνέχεια', tag: 'αν αξίζει', body: 'Ιδιωτικά, 1:1, online. Στην αρχή εβδομαδιαία ώστε να χτίζεται η δουλειά, μετά ευέλικτα. Συνεχίζει μόνο όσο είναι πραγματικά χρήσιμο.' },
    ],
    ...
    not: [
      'Δεν είναι κλασικό business coaching — δεν υπάρχει framework που σου δίνω να τρέξεις.',
      'Δεν είναι γενικό coaching νοοτροπίας ή αυτοπεποίθησης.',
      'Δεν είναι ψυχοθεραπεία αποκομμένη από την επιχείρηση.',
    ],
    ...
    faqLabel: 'Συχνές ερωτήσεις',
    faq: [
      { q: 'Χρειάζεται να έχω ήδη επιχείρηση;', a: 'Όχι. Δεν χρειάζεται να έχεις έσοδα — είναι για ανθρώπους που προσπαθούν σοβαρά να χτίσουν κάτι, μισθωτούς ή ανεξάρτητους, είτε σχεδιάζεις έξοδο, είτε δουλεύεις freelance, είτε τρέχεις ήδη κάτι μικρό.' },
      { q: 'Είναι θεραπεία;', a: 'Είναι therapy-informed και είμαι Σύμβουλος Ψυχικής Υγείας εγγεγραμμένος στο BACP, αλλά δεν είναι θεραπεία με το πρωτόκολλο — πιο άμεση και προσανατολισμένη στη δράση, πάντα δεμένη με αυτό που χτίζεις.' },
      { q: 'Είναι business coaching;', a: 'Υπάρχει συμβουλευτική μέσα, αλλά όχι framework που σου δίνω να τρέξεις. Είναι πραγματική δουλειά πάνω στην προσφορά, την τιμολόγηση, την απόφαση μπροστά σου.' },
      { q: 'Τι επιχειρηματικά προβλήματα μπορούμε να δουλέψουμε;', a: 'Προσφορά, positioning, τιμολόγηση, εύρεση πελατών, πωλήσεις, προτεραιότητες, αποφάσεις, εκτέλεση — την πρακτική δουλειά του χτισίματος.' },
      { q: 'Κι αν το πρόβλημα δεν είναι τελικά ψυχολογικό;', a: 'Τότε το αντιμετωπίζουμε ως το επιχειρηματικό πρόβλημα που είναι. Δεν είναι όλα μοτίβο — κάποιες φορές η προσφορά είναι απλώς αδύναμη ή η τιμολόγηση λάθος, και το διορθώνουμε.' },
      { q: 'Πώς αποφασίζουμε αν θα εστιάσουμε στην επιχείρηση ή στον άνθρωπο;', a: 'Εβδομάδα με εβδομάδα, με βάση το τι πραγματικά εμποδίζει την πρόοδο. Κάποιες εβδομάδες είναι 90% επιχείρηση· κάποιες, η επιχείρηση μόλις που αναφέρεται.' },
      { q: 'Είναι μόνο για όσους αφήνουν τη μισθωτή εργασία;', a: 'Όχι — μισθωτοί, ανεξάρτητοι, ή κάποιος που τρέχει ήδη κάτι. Το κοινό είναι ότι προσπαθείς σοβαρά να χτίσεις.' },
    ],
  },
};
function notLine(txt) {
  return React.createElement('li', { style: { display: 'flex', gap: '.7rem', alignItems: 'baseline', padding: '.55rem 0', fontSize: '16px', lineHeight: 1.55, color: C.text } },
...
function OneToOnePage({ lang = 'en' }) {
  ...
  return React.createElement('main', { style: mobPage },
    React.createElement('h1', { style: { ...h1Style, marginBottom: mob ? '1.25rem' : '1.5rem', fontSize: mob ? '26px' : '32px' } }, c.h1),
    React.createElement('p', { style: { ...leadStyle, marginBottom: mob ? '1.4rem' : '1.6rem' } }, c.lead),
    React.createElement('p', { style: { ...pStyle, marginBottom: mob ? '2.5rem' : '3.25rem' } }, c.intro),

    React.createElement(Section, { label: c.whoLabel, mob },
      React.createElement(P, null, c.whoLead),
      React.createElement(Bullets, { items: c.who, mob })
    ),

    React.createElement(Section, { label: c.workLabel, mob },
      React.createElement(TrackCards, { mob, tracks: c.tracks }),
      React.createElement('p', { style: { fontSize: '16px', lineHeight: 1.7, color: C.muted, margin: '1.1rem 0 0' } }, c.workFoot)
    ),

    React.createElement('hr', { style: sepStyle }),

    React.createElement('section', { style: { marginBottom: mob ? '2.75rem' : '3.5rem' } },
      React.createElement(Kicker, null, c.howLabel),
      React.createElement(StepCards, { mob, steps: c.steps }),
      React.createElement('p', { style: { fontSize: '16px', lineHeight: 1.7, color: C.muted, margin: '1.1rem 0 0' } }, c.howNote)
    ),

    React.createElement(Section, { label: c.expectLabel, mob },
      React.createElement(Bullets, { items: c.expect, mob }),
      React.createElement('p', { style: { fontSize: '16px', lineHeight: 1.7, color: C.muted, margin: '1.1rem 0 0' } }, c.expectFoot)
    ),
    ...
    React.createElement(Section, { label: c.evLabel, mob },
      ev.map((t, i) => React.createElement(Testimonial, { key: i, quote: t.q, who: t.w })),
      React.createElement('p', { style: { marginBottom: 0, marginTop: '.4rem' } },
        React.createElement(IA, { href: pathFor('reviews', lang) }, tUI(lang).readMore))
    ),
...
const ABOUT = {
  en: {
    ...
    sections: [
      { label: 'The business career', body: ["I spent 18+ years in tech, in product and growth — building my own companies, working inside startups and large organisations, and advising more than 500 businesses.", "So when we talk about your offer, your pricing, the sale you’re avoiding or the hire you keep postponing, I’m not translating it into therapy language. I’ve done the work and I know the terrain."] },
      { label: 'The therapy training', body: ["Alongside that I trained as a therapist — an MSc in Integrative Counselling & Psychotherapy (University of Derby) and registration with the BACP. That training is why I can see the pattern underneath a business problem, and actually work with it, rather than just naming it."] },
      { label: 'Why the two converged', body: ["I kept meeting the same thing from both directions. As an advisor, the business problem often traced back to something in the person. As a therapist, ambitious people were carrying real commercial problems that pure therapy wasn’t equipped to touch.", "Working across both isn’t a gimmick. It’s the only honest way I’ve found to help — because the constraint is often on one side, sometimes the other, and frequently both at once."] },
      { label: 'Both sides of the desk', body: ["I understand employment and I understand trying to build something independent, because I’ve done both — including building this practice right now. I know what it is to have a lot to lose, and I know what it is to start from nothing."] },
      { label: 'Ambition isn’t the pathology', body: ["I’m not here to convince ambitious people that wanting more is secretly unhealthy. Wanting to build is not a symptom. The work is to help you build what you actually want, while understanding the patterns that get in the way of building it."] },
    ],
  ...
  el: {
    ...
    sections: [
      { label: 'Η επιχειρηματική πορεία', body: ['Πέρασα 18+ χρόνια στην τεχνολογία, στο product και το growth — έχτισα δικές μου εταιρείες, δούλεψα σε startups και μεγάλους οργανισμούς, και συμβούλεψα περισσότερες από 500 επιχειρήσεις.', 'Έτσι, όταν μιλάμε για την προσφορά σου, την τιμολόγηση, την πώληση που αποφεύγεις ή την πρόσληψη που αναβάλλεις, δεν το μεταφράζω σε γλώσσα θεραπείας. Έχω κάνει τη δουλειά και ξέρω το έδαφος.'] },
      { label: 'Η εκπαίδευση στη συμβουλευτική', body: ['Παράλληλα εκπαιδεύτηκα ως Σύμβουλος Ψυχικής Υγείας — MSc in Integrative Counselling & Psychotherapy (University of Derby) και εγγραφή στο BACP. Αυτή η εκπαίδευση είναι ο λόγος που μπορώ να δω το μοτίβο κάτω από ένα επιχειρηματικό πρόβλημα, και να δουλέψω πραγματικά με αυτό, αντί απλώς να το ονομάσω.'] },
      { label: 'Γιατί συνέκλιναν τα δύο', body: ['Συναντούσα το ίδιο πράγμα κι από τις δύο κατευθύνσεις. Ως σύμβουλος, το επιχειρηματικό πρόβλημα συχνά κατέληγε σε κάτι μέσα στον άνθρωπο. Ως Σύμβουλος Ψυχικής Υγείας, φιλόδοξοι άνθρωποι κουβαλούσαν πραγματικά εμπορικά προβλήματα που η καθαρή θεραπεία δεν ήταν εξοπλισμένη να αγγίξει.', 'Το να δουλεύω και τα δύο δεν είναι κόλπο. Είναι ο μόνος ειλικρινής τρόπος που έχω βρει να βοηθήσω — γιατί το εμπόδιο είναι συχνά στη μία πλευρά, κάποιες φορές στην άλλη, και πολύ συχνά και στις δύο μαζί.'] },
      { label: 'Και τις δύο πλευρές', body: ['Καταλαβαίνω τη μισθωτή εργασία και καταλαβαίνω το να προσπαθείς να χτίσεις κάτι ανεξάρτητο, γιατί έχω κάνει και τα δύο — μαζί με το χτίσιμο αυτής της πρακτικής τώρα. Ξέρω τι σημαίνει να έχεις πολλά να χάσεις, και ξέρω τι σημαίνει να ξεκινάς από το μηδέν.'] },
      { label: 'Η φιλοδοξία δεν είναι παθολογία', body: ['Δεν είμαι εδώ για να πείσω φιλόδοξους ανθρώπους ότι το να θέλουν περισσότερα είναι κρυφά ανθυγιεινό. Το να θέλεις να χτίσεις δεν είναι σύμπτωμα. Η δουλειά είναι να σε βοηθήσω να χτίσεις αυτό που πραγματικά θέλεις, κατανοώντας τα μοτίβα που μπαίνουν εμπόδιο.'] },
    ],
...
function AboutPage({ lang = 'en' }) {
  ...
  const mobPage = mob ? { ...pageStyle, padding: '1.5rem 1.1rem 5rem' } : widePageStyle;
  return React.createElement('main', { style: mobPage },
    React.createElement('h1', { style: { ...h1Style, marginBottom: '1.5rem', fontSize: mob ? '26px' : '32px' } }, c.h1),
    React.createElement('div', { style: { display: 'flex', gap: '1.2rem', alignItems: 'center', marginBottom: '2.5rem', paddingBottom: '2rem', borderBottom: `1px solid ${C.border}` } },
      ...
      React.createElement('div', null,
        React.createElement('div', { style: { fontSize: '12px', letterSpacing: '.12em', textTransform: 'uppercase', color: '#777' } }, c.role),
        React.createElement('div', { style: { fontSize: '12px', letterSpacing: '.04em', color: '#767676', marginTop: '4px', lineHeight: 1.5 } }, c.creds)
      )
    ),
    React.createElement('p', { style: { ...leadStyle, marginBottom: mob ? '2rem' : '2.5rem' } }, c.lead),
...
const REVIEWS_ITEMS = [
  ...
  { q: "I trust Aggelos because he is not constantly trying to reassure me. He listens carefully, but he does not automatically agree with the version of events I bring into the session. Sometimes he points out something I would rather not see. Somehow that honesty has made the work feel safer, not less safe.", w: 'Anonymous client, Product leader' },
  ...
  { q: "There are no motivational speeches or generic frameworks pasted onto every situation. Aggelos pays attention to how I specifically operate. He remembers the contradictions, notices when I change the story and asks the question I was hoping we could avoid. Annoying at times, but usually accurate.", w: 'Anonymous client, Founder' },
...
function ReviewsPage({ lang = 'en' }) {
  ...
  return React.createElement('main', { style: mobPage },
    ...
    React.createElement('p', { style: { ...leadStyle, marginBottom: c.note ? '1rem' : '2.5rem' } }, c.lead),
    c.note && React.createElement('p', { style: { fontSize: '14px', color: C.muted, fontStyle: 'italic', marginBottom: '2.5rem' } }, c.note),
    React.createElement('div', { style: { columnGap: mob ? 0 : '2.5rem', columnCount: mob ? 1 : 2 } },
      REVIEWS_ITEMS.map((t, i) => React.createElement('div', { key: i, style: { breakInside: 'avoid', marginBottom: '.4rem' } },
        React.createElement(Testimonial, { quote: t.q, who: t.w })
      ))
    ),
    React.createElement(FinalCta, { lang, mob, heading: c.ctaHeading }),
    React.createElement(SiteFooter, { mob, lang })
...
const BOOK = {
  en: {
    ...
    s1a: '1. Fit call.', s1b: " A short call to see if there's a fit. Not a session.",
    s2a: '2. First session.', s2b: " We get into the actual thing — the business, and whatever's underneath it. You bring the problem as you see it; we find the more accurate one.",
    s3a: '3. Ongoing.', s3b: " If it's useful, we continue. Private, 1:1, for as long as it genuinely helps.",
  ...
  el: {
    ...
    s1a: '1. Γνωριμία.', s1b: ' Μια σύντομη κλήση για να δούμε αν ταιριάζουμε. Δεν είναι συνεδρία.',
    s2a: '2. Πρώτη συνεδρία.', s2b: ' Μπαίνουμε στο πραγματικό θέμα — την επιχείρηση, και ό,τι υπάρχει από κάτω. Φέρνεις το πρόβλημα όπως το βλέπεις· βρίσκουμε το πιο ακριβές.',
    s3a: '3. Συνέχεια.', s3b: ' Αν είναι χρήσιμο, συνεχίζουμε. Ιδιωτικά, 1:1, όσο πραγματικά βοηθά.',
...
function BookPage({ lang = 'en' }) {
  ...
  return React.createElement('main', { style: mobPage },
    React.createElement('h1', { style: { ...h1Style, marginBottom: mob ? '1.25rem' : '1.75rem', fontSize: mob ? '24px' : '30px' } }, c.h1),
    React.createElement('p', { style: { ...leadStyle, marginBottom: '1.4rem' } }, c.lead),
    React.createElement(P, null, c.p1),
    React.createElement(P, { last: true }, c.p2),
    React.createElement('div', { style: { marginTop: mob ? '2.5rem' : '3.5rem' } }),
    React.createElement(Section, { label: c.howLabel, mob },
      React.createElement(P, null, React.createElement(Strong, null, c.s1a), c.s1b),
      React.createElement(P, null, React.createElement(Strong, null, c.s2a), c.s2b),
      React.createElement(P, { last: true }, React.createElement(Strong, null, c.s3a), c.s3b)
    ),
    React.createElement('h2', { style: { ...h2Style, color: C.accent, marginBottom: '1.2rem' } }, c.bookBelow),
    ...
    React.createElement('hr', { style: sepStyle }),
    React.createElement(Section, { label: c.whoLabel, mob },
      React.createElement(P, { last: true }, c.who)
    ),
    React.createElement(SiteFooter, { mob, lang })
  );
}
...
function ConfidentialityPage({ lang = 'en' }) {
  ...
  return React.createElement('main', { style: locMobPage(mob) },
    ...
    React.createElement(Section, { label: 'Nothing goes back to the people involved', mob },
      React.createElement(P, null, "This is the one clients ask about most, so it’s worth being explicit. You can bring, and work on, any of the following without it reaching the people concerned:"),
    ...
    React.createElement(Section, { label: 'Ask before you commit', mob },
      ...
      React.createElement(BookCta, { lang: 'en' })
    ),

    React.createElement(SiteFooter, { mob, lang: 'en' })
  );
}
...
function ConfidentialityPageEl() {
  const mob = useIsMobile();
  const liStyle = { marginBottom: '.5rem' };
  return React.createElement('main', { style: locMobPage(mob) },
    React.createElement('h1', { style: { ...h1Style, marginBottom: mob ? '1.25rem' : '1.75rem', fontSize: mob ? '24px' : '30px' } }, 'Εμπιστευτικότητα'),
    React.createElement('p', { style: { ...leadStyle, marginBottom: mob ? '2.5rem' : '3rem' } },
    ...
    React.createElement(Section, { label: 'Γιατί υπάρχει αυτή η σελίδα', mob },
      React.createElement(P, null, 'Οι άνθρωποι που έρχονται σε μένα χτίζουν κάτι δικό τους — κάποιοι είναι μισθωτοί, κάποιοι ανεξάρτητοι, κάποιοι τρέχουν μια εταιρεία. Οι συζητήσεις μας μπορεί να αγγίζουν cofounders, εργαζομένους, επενδυτές και πελάτες — και έσοδα, τιμολόγηση, runway, σχέδια προϊόντος — μαζί με αποφάσεις καριέρας, σχέσεις και υγεία.'),
      React.createElement(P, { last: true }, 'Πληροφορίες, δηλαδή, που μπορεί να έχουν πραγματικές επαγγελματικές ή προσωπικές συνέπειες αν βγουν από το πλαίσιο στο οποίο ειπώθηκαν. Η εμπιστευτικότητα εδώ δεν είναι τυπικότητα· είναι αυτό που επιτρέπει να γίνει η δουλειά με ειλικρίνεια.')
    ),
    React.createElement(Section, { label: 'Σε τι μπορείς να βασιστείς', mob },
      React.createElement(PatternList, { items: [
        { cause: 'Οι συνεδρίες είναι εμπιστευτικές', effect: 'όσα λες μένουν ιδιωτικά, μέσα στα όρια παρακάτω' },
        { cause: 'Δεν ενημερώνω τρίτους', effect: 'τίποτα δεν πάει σε εργοδότη, επενδυτές, board, cofounder, ομάδα ή οικογένεια' },
        { cause: 'Η πληρωμή δεν αγοράζει πρόσβαση', effect: 'αν κάποιος άλλος χρηματοδοτεί, δεν μαθαίνει τι ειπώθηκε' },
        { cause: 'Καμία αναγνωρίσιμη ιστορία', effect: 'δεν χρησιμοποιώ αναγνωρίσιμο υλικό δημόσια χωρίς ρητή άδεια' },
        { cause: 'Μπορείς να ρωτήσεις πρώτα', effect: 'κάθε πρακτική ερώτηση για την εμπιστευτικότητα είναι θεμιτή πριν δεσμευτείς' },
      ] })
    ),
    React.createElement(Section, { label: 'Τίποτα δεν επιστρέφει στους ανθρώπους γύρω σου', mob },
      React.createElement(P, null, 'Μπορείς να φέρεις και να δουλέψεις οτιδήποτε από τα παρακάτω χωρίς να φτάσει στους ανθρώπους που αφορά:'),
      React.createElement('ul', { style: { margin: '0 0 1.2rem', paddingLeft: '1.2rem', lineHeight: 1.9, fontSize: '17px', color: C.text } },
        React.createElement('li', { style: liStyle }, 'Αμφιβολίες για την εταιρεία ή τον ρόλο σου'),
        React.createElement('li', { style: liStyle }, 'Ένταση με έναν cofounder ή συνεργάτη'),
        React.createElement('li', { style: liStyle }, 'Ανησυχίες για εργαζομένους ή αποφάσεις που φοβάσαι να πάρεις'),
        React.createElement('li', { style: liStyle }, 'Πίεση από επενδυτές ή το board'),
        React.createElement('li', { style: liStyle }, 'Οικονομικό φόβο — runway, έσοδα, το επόμενο τρίμηνο'),
        React.createElement('li', { style: liStyle }, 'Την επιθυμία να φύγεις, να πουλήσεις ή να σταματήσεις'),
        React.createElement('li', { style: liStyle }, 'Απώλεια κινήτρου και προσωπικά ζητήματα που περνούν στη δουλειά')
      ),
      React.createElement(P, { last: true }, 'Δεν έχω θέση στο cap table σου ούτε στο οργανόγραμμα. Δεν μιλάω στους ανθρώπους σου. Δεν υπάρχει δεύτερο κανάλι, ούτε προς όποιον σε σύστησε.')
    ),
    React.createElement(Section, { label: 'Τα όρια — με ειλικρίνεια', mob },
      React.createElement(P, null, 'Δεν θα υποσχεθώ απόλυτη, ανεπιφύλακτη μυστικότητα, γιατί αυτή η υπόσχεση δεν κρατιέται με ειλικρίνεια. Η εμπιστευτικότητα είναι ο ισχυρός κανόνας. Σε ελάχιστες περιπτώσεις μπορεί να έχει όρια:'),
      React.createElement('div', { style: { margin: '.4rem 0 1.2rem' } },
        React.createElement(TrackCards, { mob, tracks: [
          { title: 'Σοβαρός, άμεσος κίνδυνος', body: 'Αν υπάρχει πραγματικός και άμεσος κίνδυνος σοβαρής βλάβης για εσένα ή κάποιον άλλον, μπορεί να χρειαστεί να ενεργήσω — ιδανικά μαζί σου, όχι γύρω σου.' },
          { title: 'Νόμος και προστασία', body: 'Σε περιορισμένες περιπτώσεις ο νόμος μπορεί να απαιτεί κοινοποίηση — για παράδειγμα μια δικαστική εντολή, ή ζήτημα προστασίας παιδιού ή ευάλωτου προσώπου.' },
        ] })
      ),
      React.createElement(P, { last: true }, 'Ως Σύμβουλος Ψυχικής Υγείας δουλεύω μέσα σε επαγγελματικό δεοντολογικό πλαίσιο (εγγεγραμμένος στο BACP) και χρησιμοποιώ κλινική εποπτεία, που είναι standard και η ίδια εμπιστευτική. Στην εποπτεία, το υλικό συζητείται με τρόπο που προστατεύει την ταυτότητά σου.')
    ),
    React.createElement(Section, { label: 'Αυτή η σελίδα δεν είναι το νομικό έγγραφο', mob },
      React.createElement(P, { last: true }, 'Η σελίδα εξηγεί πώς σκέφτομαι την εμπιστευτικότητα. Δεν αντικαθιστά τη συμφωνία συνεργασίας, την ενημέρωση για τα προσωπικά δεδομένα, μια φόρμα συναίνεσης ή ένα NDA. Όπου ισχύουν, αυτά τα έγγραφα υπερισχύουν όσων συνοψίζονται εδώ.')
    ),
    React.createElement(Section, { label: 'Ρώτησε πριν δεσμευτείς', mob },
      React.createElement(P, null, 'Αν η εμπιστευτικότητα είναι αυτό που σε εμποδίζει να ξεκινήσεις, είναι καλή χρήση μιας γνωριμίας. Φέρε τη συγκεκριμένη ανησυχία — τον cofounder που δεν πρέπει να μάθει, τον επενδυτή, το NDA — και θα σου πω ακριβώς πώς λειτουργεί, μαζί με ό,τι δεν μπορώ να υποσχεθώ.'),
      React.createElement(BookCta, { lang: 'el' })
    ),
