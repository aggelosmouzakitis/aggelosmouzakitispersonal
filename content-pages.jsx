...
function Section({ label, children }) {
  return React.createElement('section', { style: sectionStyle },
    React.createElement('h2', { style: h2Style }, label),
...
function HomePage({ setPage }) {
  return React.createElement('main', { style: pageStyle },
    React.createElement('header', { style: { marginBottom: '4rem', borderBottom: `1px solid ${C.border}`, paddingBottom: '3rem' } },
      ...
      React.createElement('h1', { style: { ...h1Style, marginBottom: '1.5rem', fontSize: '24px' } },
    ...
    React.createElement(Section, { label: 'What I do' },
    ...
    React.createElement(Section, { label: 'Who I work with' },
    ...
    React.createElement(Section, { label: 'Product growth' },
    ...
    React.createElement(Section, { label: 'Next step' },
...
function ExecTherapyPage() {
  return React.createElement('main', { style: pageStyle },
    React.createElement('h1', { style: { ...h1Style, marginBottom: '3rem', fontSize: '28px' } },
      'Therapy for executives who have done everything right and still feel like something is off'
    ),

    React.createElement(Section, { label: 'The problem' },
    ...
    React.createElement(Section, { label: 'What executive therapy is' },
    ...
    React.createElement(Section, { label: 'How I work' },
    ...
    React.createElement(Section, { label: 'Who this is for' },
    ...
    React.createElement(Section, { label: 'How it works' },
    ...
    React.createElement(Section, { label: 'Common questions' },
...
function FoundersTherapyPage() {
  return React.createElement('main', { style: pageStyle },
    ...
    React.createElement(Section, { label: 'The founder problem' },
    ...
    React.createElement(Section, { label: 'What I see in founders' },
    ...
    React.createElement(Section, { label: 'Why I understand this' },
...
function ImposterPage() {
  return React.createElement('main', { style: pageStyle },
    ...
    React.createElement(Section, { label: 'The pattern' },
    ...
    React.createElement(Section, { label: 'Why it gets worse with seniority' },
    ...
    React.createElement(Section, { label: 'What doesn\u2019t work' },
    ...
    React.createElement(Section, { label: 'How I work with this' },
    ...
    React.createElement(Section, { label: 'Start here' },
...
function BurnoutPage() {
  return React.createElement('main', { style: pageStyle },
    ...
    React.createElement(Section, { label: 'Executive burnout' },
...
function CareerTransitionPage() {
  return React.createElement('main', { style: pageStyle },
    ...
    React.createElement(Section, { label: 'The real transition' },
    ...
    React.createElement(Section, { label: 'What makes this hard' },
    ...
    React.createElement(Section, { label: 'Why a therapist, not a career coach' },
