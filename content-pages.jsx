...
function SolopreneursPage() {
  ...
  return React.createElement('main', { style: mobPage },
    ...
    React.createElement(Section, { label: 'What you came here for', mob },
      React.createElement(P, null, "You came here about the business. Typical things I've heard so far include sales you keep not doing, pricing you are afraid to increase, constantly changing directions, lack of focus and procrastination, client conversations that put you on fight or flight, decisions you keep putting off or lack of drive for the business itself. These are just a few examples."),
      React.createElement(P, { last: true },
