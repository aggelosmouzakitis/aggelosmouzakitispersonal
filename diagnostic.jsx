...
const DIAG = {
  ...
  el: {
    ...
    s2: { label: 'Το business', statements: [
      'Το offer μου είναι ξεκάθαρο και ο κόσμος καταλαβαίνει εύκολα τι πουλάω.',
      'Ξέρω σε ποιους ακριβώς προσπαθώ να πουλήσω.',
      'Έχω έναν σχετικά σταθερό τρόπο να βρίσκω πιθανούς πελάτες.',
      'Μιλάω με πιθανούς πελάτες αρκετά συχνά.',
      'Οι τιμές μου βγάζουν εμπορικό νόημα.',
      'Ξέρω ποια είναι η σημαντικότερη επόμενη κίνηση για το business.',
      'Είμαι αρκετά συγκεντρωμένος σε μία κατεύθυνση ώστε η προσπάθεια να αρχίσει να συσσωρεύεται.',
      'Ξέρω τι πραγματικά δουλεύει και τι απλώς ελπίζω ότι θα δουλέψει.',
    ] },
    s3: { label: 'Το να το κάνεις εσύ', statements: [
      "Συχνά ξέρω ποια είναι η λογική business κίνηση και παρ' όλα αυτά δεν την κάνω.",
      'Περνάω υπερβολικό χρόνο προετοιμάζοντας, ψάχνοντας ή βελτιώνοντας κάτι πριν το βγάλω προς τα έξω.',
      "Το να πουλήσω ή να προωθήσω τον εαυτό μου με δυσκολεύει περισσότερο απ' όσο θα έπρεπε.",
      'Μια απόρριψη μπορεί να με επηρεάζει πολύ αφού το ίδιο το γεγονός έχει τελειώσει.',
      'Δυσκολεύομαι να ζητήσω τα χρήματα που πραγματικά πιστεύω ότι αξίζει η δουλειά μου.',
      'Αλλάζω κατεύθυνση πριν δοκιμάσω πραγματικά αυτή που ήδη έχω.',
      'Ξανανοίγω αποφάσεις που θεωρητικά έχω ήδη πάρει.',
      'Μπορώ να εξηγήσω πολύ καλά κάποια μοτίβα μου χωρίς αυτό να σημαίνει ότι τα αλλάζω.',
      'Όσο περισσότερο με νοιάζει κάτι, τόσο πιο περίπλοκο τείνω να το κάνω.',
      'Μερικές φορές γεμίζω τη μέρα με χρήσιμη δουλειά για να αποφύγω αυτή που πραγματικά έχει σημασία.',
    ] },
    s4: { label: 'Εσύ μέσα στο business', statements: [
      'Το πόσο καλά πηγαίνει το business επηρεάζει το πώς νιώθω για τον εαυτό μου.',
      'Δυσκολεύομαι να χαλαρώσω όταν ξέρω ότι υπάρχει κάτι ακόμα που θα μπορούσα να κάνω.',
      'Με δυσκολεύει να με βλέπουν οι άλλοι να αμφιβάλλω, να δυσκολεύομαι ή να μην έχω τον έλεγχο.',
      'Το να είμαι αυτός που «θα βρει τη λύση» είναι σημαντικό κομμάτι της ταυτότητάς μου.',
      'Αναλαμβάνω πράγματα που πιθανότατα θα μπορούσαν να χειριστούν και άλλοι χωρίς εμένα.',
      'Το να αφήσω λίγο το control μου φαίνεται πιο επικίνδυνο από το να κρατάω υπερβολικά πολύ.',
      'Μερικές φορές αναρωτιέμαι ποιος θα ήμουν αν σταματούσα να πιέζω τόσο πολύ.',
      "Έχω πετύχει πράγματα που κάποτε ήθελα πάρα πολύ και όταν τα κατάφερα ένιωσα πολύ λιγότερα απ' όσα περίμενα.",
      'Το business συνεχίζει να τρέχει στο μυαλό μου ακόμα κι όταν θεωρητικά δεν δουλεύω.',
      'Η πίεση της δουλειάς περνάει στη διάθεσή μου, στο σώμα μου ή στις σχέσεις μου.',
      'Μερικές φορές δυσκολεύομαι να καταλάβω αν κινούμαι προς κάτι που θέλω ή απλώς τρέχω μακριά από κάτι που φοβάμαι.',
      'Υπάρχουν πράγματα που σκέφτομαι για τη δουλειά μου και δεν νιώθω ότι μπορώ να τα πω εύκολα στους ανθρώπους γύρω μου.',
    ] },
    s5: {
      label: 'Τι συμβαίνει τώρα;',
      opens: [
        'Αν δουλεύαμε μαζί και πήγαινε πραγματικά καλά, τι θα ήταν διαφορετικό σε έξι μήνες από σήμερα;',
        ...
        'Υπάρχει κάτι για το business, τη δουλειά ή εσένα που δεν σε ρώτησα αλλά θεωρείς ότι θα έπρεπε να ξέρω; (προαιρετικό)',
      ],
      name: 'Όνομα',
      email: 'Email',
