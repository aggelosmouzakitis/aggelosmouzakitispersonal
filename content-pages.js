...
const HOME = {
  ...
  el: {
    ...
    recog: ['Θέλεις καιρό να ξεκινήσεις κάτι. Ακόμα ετοιμάζεσαι.', "Χρειάζεσαι περισσότερους πελάτες. Κι όμως, πάντα βρίσκεται κάτι πιο επείγον από το να πουλήσεις.", 'Ξέρεις ότι χρεώνεις λίγο. Η τιμή, όμως, παραμένει ίδια.', 'Κάθε φορά που η κατεύθυνση που διάλεξες δυσκολεύει, εμφανίζεται μια καινούρια που ξαφνικά μοιάζει καλύτερη.', 'Η επιχείρηση εξαρτάται από εσένα σχεδόν για τα πάντα. Δεν ξέρεις πόσο από αυτό είναι όντως απαραίτητο.', 'Στα χαρτιά, τα πράγματα πάνε καλά. Εσύ, όμως, νιώθεις όλο και λιγότερο συνδεδεμένος με αυτό που χτίζεις.', 'Έφτασες κάπου που ήθελες πολύ. Όμως τώρα δεν ξέρεις αν θέλεις πραγματικά να πας στο επόμενο επίπεδο ή απλώς πιστεύεις ότι θα έπρεπε να το θέλεις.', 'Καταλαβαίνεις πολύ καλά τα μοτίβα σου. Παραδόξως, συνεχίζεις να τα επαναλαμβάνεις.'],
    ...
    bvyBusiness: ['Το offer σου είναι ακόμα αδύναμο.', 'Το positioning δεν είναι αρκετά ξεκάθαρο.', 'Δεν έχεις σταθερό τρόπο να βρίσκεις πελάτες.', 'Το pricing σου δεν βγάζει νόημα.', 'Κυνηγάς πέντε πράγματα ταυτόχρονα.', 'Δεν ξέρεις ποια κίνηση έχει πραγματικά σημασία τώρα.'],
    bvyYou: ['Ξέρεις ότι πρέπει να πουλήσεις. Όμως, το αποφεύγεις.', "Ένα «όχι» σε χτυπάει πιο προσωπικά απ' όσο θα ήθελες.", 'Ο φόβος έκθεσης σε κρατά πίσω, παρότι ξέρεις ότι χωρίς έκθεση δύσκολα έρχεται ζήτηση.', 'Αλλάζεις κατεύθυνση πριν προλάβει να δουλέψει η προηγούμενη.', "Το πώς πάει το business επηρεάζει λίγο περισσότερο απ' όσο θα ήθελες το πώς βλέπεις τον εαυτό σου.", 'Μπορείς να εξηγήσεις τέλεια πού είναι το πρόβλημα, αλλά δεν περνάς στη δράση.'],
    ...
    faq: [{
      ...
      a: 'Όχι. Μπορεί να ξεκινάς τώρα, να δουλεύεις ως freelancer ή consultant, να χτίζεις κάτι παράλληλα με τη δουλειά σου ή να τρέχεις ήδη τη δική σου επιχείρηση. Το κοινό είναι ότι προσπαθείς σοβαρά να χτίσεις κάτι δικό σου.'
    }, {
      q: 'Είναι ψυχοθεραπεία ή συμβουλευτική επιχειρήσεων;',
      a: 'Είναι και τα δύο παράλληλα. Είμαι business growth advisor και ψυχοθεραπευτής. Αν το πρόβλημα είναι το business, δουλεύουμε το business. Αν μπαίνει κάτι δικό σου στη μέση, μπορούμε να δουλέψουμε κι αυτό.'
    }, {
...
const ONE = {
  ...
  el: {
    ...
    intro: ['Κάποια προβλήματα θέλουν μια πρακτική λύση στο business. Άλλα χρειάζονται πιο βαθιά δουλειά. Και αρκετά συχνά, δεν είναι ξεκάθαρο ποιο από τα δύο έχεις μπροστά σου μέχρι να μπούμε στο θέμα.', 'Στο 1:1 δεν χρειάζεται να διαλέξουμε από πριν.'],
    ...
    lookMaybes: ['Μπορεί να μην ξέρεις πώς θα βρεις τους επόμενους δέκα πελάτες.', 'Μπορεί να ξέρεις ακριβώς ποια συζήτηση πρέπει να κάνεις και να την αποφεύγεις εδώ και τρεις μήνες.', 'Μπορεί το business να μεγαλώνει αλλά όλα να πρέπει ακόμα να περνούν από εσένα.', 'Μπορεί κάτι που κάποτε ήθελες πάρα πολύ να μη σε γεμίζει πια και να μην ξέρεις τι σημαίνει αυτό για όσα έχεις χτίσει.', 'Ή μπορεί να έχεις αναλύσει το πρόβλημα τόσο πολύ, που η ίδια η ανάλυση έχει γίνει μέρος του προβλήματος.'],
    lookMid: 'Δουλεύουμε αυτό που υπάρχει πραγματικά μπροστά μας.',
    lookClose: ['Μπορεί να αμφισβητήσω μια απόφαση που έχεις πάρει για το business. Μπορεί να αμφισβητήσω τον τρόπο που την έχεις εξηγήσει στον εαυτό σου.', 'Κάποιες φορές θα δουλέψουμε πάνω σε ένα πλάνο. Άλλες θα χρειαστεί να μείνουμε λίγο περισσότερο σε κάτι άβολο, μέχρι να καταλάβουμε γιατί συνεχίζεις να το αποφεύγεις.', 'Δεν ψάχνουμε ψυχολογική εξήγηση για τα πάντα. Προσπαθούμε να καταλάβουμε καλύτερα τι πραγματικά συμβαίνει και μετά να εξάγουμε κάτι χρήσιμο με αυτό.'],
    howLabel: 'Πώς ξεκινάμε',
    steps: [{
      n: '1',
      title: 'Γνωριμία',
      tag: '~15 λεπτά · δωρεάν',
      body: 'Μου λες πολύ σύντομα τι χτίζεις και τι συμβαίνει. Βλέπουμε αν ταιριάζουμε και αν μπορώ πραγματικά να βοηθήσω. Είναι γνωριμία, όχι δωρεάν συνεδρία.'
    }, {
      n: '2',
    ...
    faq: [{
      ...
      a: 'Κάποιες φορές η δουλειά μας θα μπει σε θέματα που είναι ξεκάθαρα ψυχοθεραπευτικά. Έχω MSc Integrative Counselling & Psychotherapy και είμαι εγγεγραμμένο μέλος του BACP, οπότε δεν χρειάζεται να σταματήσουμε επειδή το θέμα έγινε προσωπικό. Από την άλλη, εδώ το business δεν είναι απλώς το context. Είναι κι αυτό μέρος της δουλειάς.'
    }, {
      q: 'Είναι business coaching;',
      a: 'Ναι αλλά όχι αποκλειστικά. Θα έχω άποψη για το business. Μπορούμε να δουλέψουμε κανονικά πάνω σε offer, positioning, τιμές, πελάτες ή μια δύσκολη απόφαση που έχεις μπροστά σου. Δεν έχω μια έτοιμη μέθοδο που εφαρμόζω σε όλους.'
    }, {
      ...
      q: 'Πρέπει να έχω ήδη επιχείρηση;',
      a: 'Όχι. Μπορεί να ξεκινάς τώρα, να χτίζεις κάτι παράλληλα με τη δουλειά σου, να είσαι freelancer ή consultant, ή να τρέχεις ήδη τη δική σου επιχείρηση. Το σημαντικό είναι να προσπαθείς πραγματικά να χτίσεις κάτι δικό σου.'
    }],
...
const ABOUT = {
  ...
  el: {
    ...
    sections: [{
      ...
      body: ['Στην ψυχολογική δουλειά συναντούσα φιλόδοξους ανθρώπους με πραγματικά προβλήματα στο business.', 'Και μερικές φορές αυτό που χρειάζονταν δεν ήταν μια ψυχολογική εξήγηση.', 'Το offer ήταν αδύναμο. Οι τιμές λάθος. Δεν υπήρχε σταθερός τρόπος να έρθουν πελάτες. Ή απλώς η απόφαση ήταν κακή.', 'Η ψυχοθεραπεία δεν είναι φτιαγμένη για να σε βοηθήσει με αυτό.']
    }, {
...
function ExecTherapyPage() {
  const mob = useIsMobile();
  return React.createElement(SvcPage, null, React.createElement(SvcEyebrow, null, 'Private 1:1 · Therapy for executives'), React.createElement(SvcH1, null, 'Therapy for executives who have done everything right and still feel like something is off'), React.createElement(SvcLead, null, "You're good at your job, and you know it. Somewhere along the way the cost of doing it well changed, and no amount of delegation, time off or strategy seems to touch it."), React.createElement(SvcHeroCta), React.createElement(SvcSection, {
    title: 'The problem'
...
function FoundersTherapyPage() {
  const mob = useIsMobile();
  return React.createElement(SvcPage, null, React.createElement(SvcEyebrow, null, 'Private 1:1 · Therapy for founders'), React.createElement(SvcH1, null, 'Therapy for founders who have no one to be honest with about what this actually costs'), React.createElement(SvcLead, null, "A private, confidential therapeutic relationship for founders carrying the weight of the role, from someone who has sat on both sides of the table."), React.createElement(SvcHeroCta), React.createElement(SvcSection, {
...
function ImposterPage() {
  const mob = useIsMobile();
  return React.createElement(SvcPage, null, React.createElement(SvcEyebrow, null, 'Private 1:1 · Imposter syndrome therapy'), React.createElement(SvcH1, null, 'You can see the evidence that you’re good at this. You just can’t feel it.'), React.createElement(SvcLead, null, "Imposter syndrome therapy for senior professionals who have every proof of competence and still feel like a fraud."), React.createElement(SvcHeroCta), React.createElement(SvcSection, {
    title: 'The pattern'
...
function BurnoutPage() {
  const mob = useIsMobile();
  return React.createElement(SvcPage, null, React.createElement(SvcEyebrow, null, 'Private 1:1 · Executive burnout therapy'), React.createElement(SvcH1, null, 'You took the vacation. You came back feeling the same way. The problem probably isn’t the workload.'), React.createElement(SvcLead, null, "Executive burnout therapy for leaders who rested, came back the same, and suspect the hours were never the real problem."), React.createElement(SvcHeroCta), React.createElement(SvcSection, {
...
function ElExecutiveCoachingPage() {
  ...
  return React.createElement(SvcPage, null, React.createElement(ElRoleEyebrow, null), React.createElement(ElH1, {
    ...
    items: [{
      ...
      q: 'Είναι εμπιστευτικό;',
      a: React.createElement(React.Fragment, null, 'Ναι. Δεν ενημερώνεται η ομάδα σου, το HR, ο εργοδότης, το board ή οι επενδυτές. Περισσότερα στη σελίδα ', React.createElement(IA, {
        href: '/el/confidentiality/'
      }, 'Εμπιστευτικότητα'), '.')
    }]
  })), React.createElement(RelatedLinks, {
    mob,
    heading: 'Σχετικά θέματα',
    items: [{
      href: '/el/1-to-1/',
      label: '1:1 Συνεργασία →'
    }, {
      href: '/el/burnout/',
      label: 'Burnout →'
    }, {
...
function ElBurnoutPage() {
  ...
  return React.createElement(SvcPage, null, React.createElement(ElRoleEyebrow, null), React.createElement(ElH1, {
    ...
    items: [{
      ...
      q: 'Πότε αξίζει να ζητήσω υποστήριξη;',
      a: 'Όταν η εξάντληση επιμένει και επηρεάζει τον ύπνο, τις σχέσεις ή τη συγκέντρωσή σου, ή όταν έχεις ήδη δοκιμάσει ξεκούραση και όρια αλλά επιστρέφεις σταθερά στην ίδια κατάσταση. Δεν χρειάζεται να περιμένεις μέχρι να μη μπορείς πλέον να δουλέψεις.'
    }]
  })), React.createElement(RelatedLinks, {
    mob,
    heading: 'Σχετικά θέματα',
...
function ElCareerCoachingPage() {
  ...
  return React.createElement(SvcPage, null, React.createElement(ElRoleEyebrow, null), React.createElement(ElH1, {
    ...
    items: [{
      ...
      q: 'Σε τι διαφέρει από έναν κλασικό σύμβουλο καριέρας;',
...
function ElImposterPage() {
  ...
  return React.createElement(SvcPage, null, React.createElement(ElRoleEyebrow, null), React.createElement(ElH1, {
    ...
    href: '/el/burnout/'
  }, 'burnout'), ', όταν η ανάγκη να μην αποτύχεις οδηγεί σε υπερβολική δουλειά· και με το ', React.createElement(IA, {
    href: '/el/career-coaching/'
...
function CoreApp({
  ...
  return React.createElement(window.LegacyShell, {
    page: pageId,
    lang: lang,
    form: FORM_PAGES.indexOf(pageId) !== -1
