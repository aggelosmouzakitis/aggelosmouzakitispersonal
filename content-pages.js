...
function HomePage({
  ...
  }, 'Psychotherapist & Burnout Coach'), React.createElement('h1', {
    style: {
      ...h1Style,
      marginBottom: '1.5rem',
      fontSize: mob ? '20px' : '24px'
    }
  }, "I\u2019m Aggelos Mouzakitis, a licensed psychotherapist and burnout coach for high-functioning people in tech. Based in Ireland, working globally."), React.createElement('p', {
    style: {
      ...pStyle,
      marginBottom: 0,
      maxWidth: 560
    }
  }, "I spent 18+ years working in B2B SaaS before training as a therapist. That background shapes how I work with clients now.")), React.createElement(Section, {
    label: 'What I do',
    mob
  }, React.createElement(P, null, "I work with founders, executives, and senior tech professionals on performance dependence: the pattern where achievement has become the way you regulate your sense of worth, and any disruption to performance starts threatening more than just your career."), React.createElement(P, null, "High-functioning burnout usually runs deeper than overwork. For most of the people I work with, performance became identity and proof of worth a long time ago. That can drive success for years, but it also means that when things stop going well, motivation, relationships, and your sense of self all start to crack at the same time."), React.createElement(P, {
    last: true
  }, "I help people keep their drive while ending the dependency on it.")), React.createElement(Section, {
    label: 'Who I work with',
    mob
  }, React.createElement(P, null, "Senior tech professionals, founders, VPs, and executives who are doing well by every external measure but are starting to notice what it costs. The anxiety that doesn't match the accomplishments. The irritability that leaks into relationships. The sense that taking your foot off the gas, even slightly, would reveal something you're not ready to face."), React.createElement(P, null, "I also work with people navigating imposter syndrome, career transitions, leadership isolation, and the broader identity questions that come with operating at a high level for a long time."), React.createElement(P, {
    last: true
  }, "I write about the psychology of ambition, identity, and performance at ", React.createElement(A, {
    href: 'https://undisguised.io'
  }, 'Undisguised'), ". The writing names what most people in high-stakes careers feel but rarely say out loud. The private work is where we actually change it.")), React.createElement(Section, {
    label: 'Product growth',
    mob
  }, React.createElement(P, null, "I've spent 18+ years in growth strategy across companies at every stage, from early-stage startups to ", React.createElement(A, {
    href: 'https://www.ibm.com'
  }, 'IBM'), "'s enterprise portfolio, covering PLG, pricing, activation, and go-to-market. I've worked with 50+ companies, always embedded, always hands-on."), React.createElement(P, null, "I help product-led companies turn usage into revenue. I work as a fractional growth advisor for SaaS founders and growth leaders on the problems that frameworks don't reach: activation that doesn't stick, pricing that confuses, funnels that leak in ways nobody has noticed yet."), React.createElement(P, {
    last: true
  }, React.createElement(A, {
    href: 'https://headofgrowth.io'
  }, 'How I work with founders and growth teams →'))), React.createElement(Section, {
    label: 'Next step',
    mob
  }, React.createElement(P, null, "The first session is free, 60 minutes, and has no strings. We use it to figure out where you actually are and whether working together makes sense."), React.createElement('div', {
    style: {
      marginTop: '.5rem'
    }
  }, React.createElement('a', {
  ...
  }, 'Book a free 60-minute session'))), React.createElement('footer', {
    style: footerStyle
  }, '© Aggelos Mouzakitis'));
}
...
function FoundersTherapyPage() {
  ...
  return React.createElement('main', {
    ...
    mob
  }, React.createElement(P, null, "I'm a licensed psychotherapist with 18+ years in B2B SaaS, including advising 50+ companies on growth. I've been on the other side of the table where you set targets, defend strategy, and absorb pressure from every direction."), React.createElement(P, {
    last: true
  }, "When a client comes in carrying the weight of a down round or a co-founder conflict, ", React.createElement(Strong, null, "I don't need them to explain the context"), ". I know what that room feels like. We skip the background and go straight to the work.")), React.createElement(Section, {
    label: 'How it works',
    mob
...
function ImposterPage() {
  ...
  return React.createElement('main', {
    ...
    href: 'https://headofgrowth.io'
  }, 'advising 50+ companies on growth'), ". I know the environment that amplifies imposter syndrome in tech: the pace, the ambiguity, the constant comparison."), React.createElement(P, null, React.createElement(Strong, null, "We work with the root pattern rather than the symptoms."), " That means going beyond the current role to understand where the conditional sense of worth was established, why it persists, and what it would take to build a sense of self that doesn't depend entirely on the next result."), React.createElement(P, {
    last: true
...
function BurnoutPage() {
  ...
  return React.createElement('main', {
    ...
    last: true
  }, "The goal isn't necessarily to make you work less (though that might happen). ", React.createElement(Strong, null, "The goal is to change your relationship to the work so it costs less."), " Sometimes that means structural changes. Sometimes something shifts internally and the same role becomes sustainable. The work helps clarify which.")), React.createElement(Section, {
    label: 'Start here',
    mob
...
function CareerTransitionPage() {
  ...
  return React.createElement('main', {
    ...
    href: 'https://www.undisguised.io/p/youre-creating-the-exact-problem'
  }, 'They end up building the same problem in a different context.'), ""), React.createElement(P, {
    last: true
  }, "I'm a licensed psychotherapist who made this kind of transition myself — from 18+ years in B2B SaaS and ", React.createElement(A, {
    href: 'https://headofgrowth.io'
  }, 'growth advisory'), " to clinical practice. I know what it's like to leave an identity that works, and I know the difference between doing that reactively and doing it with some clarity about what's actually driving the change.")), React.createElement(Section, {
    label: 'Who this is for',
    mob
  }, React.createElement(P, {
    last: true
