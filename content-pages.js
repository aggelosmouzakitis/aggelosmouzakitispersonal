...
function HomePage({
  ...
  }, 'High-Performance Coach & Licensed Therapist'), React.createElement('h1', {
    style: {
      ...h1Style,
      marginBottom: '1.5rem',
      fontSize: mob ? '22px' : '28px'
    }
  }, "Find genuine fulfilment without losing your ambition."), React.createElement('p', {
    style: {
      ...pStyle,
      marginBottom: '1.2rem',
      maxWidth: 600
  ...
  }, "I\u2019m Aggelos Mouzakitis, a licensed therapist with 18+ years in B2B SaaS. Based in Ireland, working globally.")), React.createElement(Section, {
    label: 'What I do',
    mob
  }, React.createElement(P, null, "Ambition isn’t the problem. Most of the people I work with are still performing well. What has changed is the cost: success starts to feel like relief rather than reward, rest feels unsafe, and setbacks land as personal threats rather than situations to handle."), React.createElement(P, {
    last: true
  ...
  }, 'Undisguised'), ". The writing names what most people in high-stakes careers feel but rarely say out loud. The private work is where we change it.")), React.createElement(Section, {
    label: 'Background',
    mob
  }, React.createElement(P, {
    last: true
  }, "Before training as a therapist I spent 18+ years in B2B SaaS growth, from early-stage startups to ", React.createElement(A, {
    href: 'https://www.ibm.com'
  }, 'IBM'), "’s enterprise portfolio, advising 50+ companies. I still work as a fractional growth advisor. ", React.createElement(A, {
    href: 'https://headofgrowth.io'
  }, 'More on that →'))), React.createElement(Section, {
    label: 'Next step',
    mob
