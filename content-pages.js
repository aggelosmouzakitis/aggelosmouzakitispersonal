...
function Testimonial({
  ...
  return React.createElement('blockquote', {
    style: {
      margin: '0 0 1.6rem',
      padding: '0 0 0 1rem',
      borderLeft: '2px solid rgba(16,187,130,0.35)'
    }
...
function Hero({
  ...
  }, 'Let me introduce myself'), React.createElement('h1', {
    style: {
      ...h1Style,
      marginBottom: '1.2rem',
      fontSize: mob ? '26px' : '34px'
    }
  }, "Hey, I'm Aggelos."), React.createElement(TBD), React.createElement(CtaLink, {
    href: '#book'
  }, 'Book a 15-min fit call')), React.createElement('div', {
    style: {
      maxWidth: mob ? 220 : 320,
      margin: mob ? '2rem auto 0' : '0'
    }
...
function HomePage({
  ...
  return React.createElement('main', {
    ...
    label: 'The frame',
    mob
  }, React.createElement(TBD)), React.createElement(Section, {
    label: 'Why me',
    mob
  }, React.createElement(TBD)), React.createElement(Section, {
    label: 'The fork',
    ...
    href: '/founders/',
    style: forkCardStyle
  }, 'For founders'), React.createElement('a', {
    href: '/solopreneurs/',
    style: forkCardStyle
  }, 'For solopreneurs'))), React.createElement(Section, {
    label: 'How it works',
    mob
  }, React.createElement(TBD), React.createElement(CtaLink, {
    href: '#book'
  }, 'Book a 15-min fit call')), React.createElement(Section, {
    label: 'Proof',
    mob
  }, React.createElement(TBD)), React.createElement(Section, {
    label: 'Writing',
    mob
  }, React.createElement(TBD), React.createElement('p', {
    style: {
      marginTop: '.4rem',
      marginBottom: 0
    }
    ...
    href: '/blog/',
    style: greenLink
  }, 'Read the writing \u2192'))), React.createElement(SiteFooter, null));
}
...
function ForkSkeletonPage({
  ...
  return React.createElement('main', {
    ...
    label: 'How the problem usually looks',
    mob
  }, React.createElement(TBD)), React.createElement(Section, {
    label: 'Why me',
    mob
    ...
    href: '#book'
  }, 'Book a 15-min fit call')), React.createElement(SiteFooter, null));
}
function FoundersPage() {
  return React.createElement(ForkSkeletonPage, {
    title: 'For founders'
  });
}
...
function HowItWorksPage() {
  ...
  return React.createElement('main', {
    ...
    style: h3Style
  }, 'Fit call'), React.createElement(TBD)), React.createElement('div', {
    style: {
      marginBottom: '1.2rem'
    }
  }, React.createElement('h3', {
    style: h3Style
  }, 'Paid session'), React.createElement(TBD)), React.createElement('div', null, React.createElement('h3', {
    style: h3Style
  }, 'Ongoing'), React.createElement(TBD))), React.createElement(Section, {
    label: 'What the diagnostic gives you',
    mob
  }, React.createElement(TBD)), React.createElement(Section, {
    label: 'Pricing logic',
    mob
...
function DiagnosticTeaserPage() {
  ...
  return React.createElement('main', {
    ...
    href: '#'
  }, 'Start assessment →')), React.createElement(Section, {
    label: 'What it is',
    mob
  }, React.createElement(TBD)), React.createElement(Section, {
    ...
    href: '#'
  }, 'Start assessment →')), React.createElement(SiteFooter, null));
}
...
function ExecTherapyPage() {
  ...
  return React.createElement('main', {
    ...
    href: 'mailto:aggelos.mouzakitis@gmail.com?subject=Free%2060-minute%20session',
    style: ctaBtn
  }, 'Get in touch for a free session'))), React.createElement(SiteFooter, null));
}
