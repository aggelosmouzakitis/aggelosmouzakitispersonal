...
function HomePageV2({
  ...
  return React.createElement(React.Fragment, null, React.createElement(window.ChromeStyles), React.createElement(PageV2Styles), React.createElement(window.SiteHeader, {
    ...
    className: 'site-container home-hero__grid'
  }, React.createElement('div', {
    className: 'home-hero__copy'
  }, React.createElement('h1', {
    className: 'home-hero__title'
  }, HERO_NAME[lang] || HERO_NAME.en), React.createElement('div', {
    className: 'home-hero__roles'
  }, React.createElement('div', null, t.role1), React.createElement('div', null, t.role2))), React.createElement('figure', {
    className: 'home-hero__photo'
  }, React.createElement('span', {
    className: 'home-hero__photo-vertical'
  }), React.createElement('span', {
    className: 'home-hero__photo-horizontal'
  }), React.createElement('img', {
    src: '/img/aggelos-homepage.webp',
    alt: u.imgAlt || 'Aggelos Mouzakitis',
    width: 1560,
    height: 1040,
    loading: 'eager',
    fetchpriority: 'high',
    ...
    className: 'offer__eyebrow'
  }, c.tagline), React.createElement('h2', {
    className: 'offer__h'
  }, c.promise)), React.createElement('div', null, React.createElement('p', null, c.introA), React.createElement('p', null, c.introB), React.createElement('a', {
    className: 'pill pill--green',
    href: window.cPath('diagnostic', lang)
  }, React.createElement('span', null, t.ctaBtn), React.createElement('span', null, '→')), React.createElement('p', {
    className: 'offer__micro'
  }, c.introC))))), React.createElement('section', {
    className: 'sec'
  }, React.createElement('div', {
    className: 'site-container'
  }, React.createElement('div', {
    ...
    className: 'sec__h'
  }, c.bvyHead), c.bvySub ? React.createElement('p', {
    className: 'sec__sub'
  }, c.bvySub) : null, React.createElement('div', {
    className: 'panel-2'
  }, React.createElement('div', {
    className: 'panel panel--paper'
  }, React.createElement('h3', null, c.bizLabel), React.createElement('ul', null, arr(c.bvyBusiness).map((x, i) => React.createElement('li', {
    key: i
  }, x)))), React.createElement('div', {
    className: 'panel panel--black'
  }, React.createElement('h3', null, c.youLabel), React.createElement('ul', null, arr(c.bvyYou).map((x, i) => React.createElement('li', {
    key: i
  }, x))))), React.createElement('p', {
    className: 'sec__after'
  }, c.bvyUnder))), React.createElement('section', {
    ...
    className: 'recog'
  }, arr(c.recog).map((x, i) => React.createElement('p', {
    key: i
  }, x))))), React.createElement('section', {
    className: 'sec sec--tight'
  }, React.createElement('div', {
    className: 'site-container'
  }, React.createElement('div', {
    ...
    className: 'paper-panel__n'
  }, '03'), React.createElement('h2', null, c.oneRelHead), React.createElement('div', {
    className: 'paper-panel__cols'
  }, React.createElement('div', null, React.createElement('div', {
    className: 'paper-panel__lbl'
  }, c.bizLabel), React.createElement('p', null, c.oneRelBizList), React.createElement('p', {
    style: {
      fontWeight: 600
    }
  }, c.oneRelBizQ)), React.createElement('div', null, React.createElement('div', {
    className: 'paper-panel__lbl'
  }, c.youLabel), React.createElement('p', null, c.oneRelYouList), React.createElement('p', {
    style: {
      fontWeight: 600
    }
  }, c.oneRelYouQ))), React.createElement('p', null, c.oneRelNote1), React.createElement('p', {
    style: {
      fontWeight: 600
    }
  }, c.oneRelNote2), React.createElement('a', {
    className: 'paper-panel__more',
    href: window.cPath('one-to-one', lang)
  }, (u.seeOneToOne || '1:1') + ' →'))))), React.createElement('section', {
    className: 'sec sec--tight'
  }, React.createElement('div', {
    className: 'site-container'
  }, React.createElement('div', {
    ...
    className: 'sec__h'
  }, media.intro), React.createElement('div', {
  ...
  }, 'UNDISGUISED'), React.createElement('p', null, media.read))), React.createElement('a', {
    ...
    className: 'media__kicker'
  }, 'YOUTUBE'), React.createElement('p', null, media.watch))), React.createElement('div', {
    ...
    name: 'TikTok',
    size: 20
  }))))))), arr(c.faq).length ? React.createElement('section', {
    className: 'sec sec--tight'
  }, React.createElement('div', {
    className: 'site-container u-faq u-faq--dark',
    style: {
      maxWidth: 900
    }
  ...
  }, c.faqLabel), arr(c.faq).map((f, i) => React.createElement('details', {
    key: i
  }, React.createElement('summary', null, f.q), React.createElement('p', null, f.a))))) : null, React.createElement(window.BlackCtaStrip, {
    lang,
...
function AboutPageV2({
  ...
  return React.createElement(React.Fragment, null, React.createElement(window.ChromeStyles), React.createElement(PageV2Styles), React.createElement(window.SiteHeader, {
  ...
  }, intro[0]) : null, React.createElement('div', {
    className: 'why-hero__creds'
  }, c.role)), React.createElement('img', {
    ...
    className: 'cred-row__n'
  }, '0' + (i + 1)), React.createElement('h3', null, r), React.createElement('p', null, '')))) : null, React.createElement('div', {
    className: 'u-read',
    style: {
      marginTop: rows.length ? 80 : 0
    }
...
function ReviewsPageV2({
  ...
  }, c.sub))), first ? React.createElement('blockquote', {
    className: 'rev-feature'
  }, '“' + (el ? first.qEl : first.q) + '”', React.createElement('div', {
    className: 'rev-feature__who'
  }, el ? first.wEl : first.w)) : null)), React.createElement('section', {
    className: 'u-main'
  }, React.createElement('div', {
    className: 'site-container rev-grid'
  }, items.slice(1).map((t, i) => React.createElement(ReviewItemV2, {
    key: i,
    t,
    lang,
