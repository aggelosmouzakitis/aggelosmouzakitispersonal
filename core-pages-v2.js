...
const HOME_SHIFTS = [{
  n: '01',
  a: 'I need more clients but keep avoiding sales.',
  b: 'I have a sales process I actually use.'
}, {
  n: '02',
  a: 'I want to leave my job but don\u2019t know what comes next.',
  b: 'I have a direction I\u2019ve tested before I quit.'
}, {
  n: '03',
  a: 'The business works, but it needs too much of me.',
  b: 'I know what needs to change so it relies less on me.'
}, {
  n: '04',
  a: 'I keep saying yes and regretting it afterwards.',
  b: 'I can set a boundary and hold it.'
}];
...
const WHY_V2 = {
  en: {
    ...
    bridgeBody: ['For years, part of my job was understanding why people buy something, switch to something else, stay where they are or hesitate. I did that through customer research and Jobs to be Done.', 'You learn quickly that the first explanation is often incomplete. So you reconstruct what happened, what someone was trying to achieve and what made the change easier or harder.'],
    bridgeClose: 'I realised I was using the same investigative habit with clients.',
    bridgeSteps: [{
      n: '01',
      t: 'What changed just before they started looking.'
    }, {
      n: '02',
      t: 'What they were trying to achieve.'
    }, {
      n: '03',
      t: 'What pulled them towards the new thing.'
    }, {
      n: '04',
      t: 'What the old thing was still doing for them.'
    }],
    originNum: '01',
...
function HomePageV2({
  ...
  const startSection = isEn ? React.createElement(FreeDisc, {
    ...
    className: 'home-free__head'
  }, React.createElement('div', null, SecLabel('02', 'Free tools'), React.createElement('h2', {
  ...
  }, React.createElement('span', null, t.ctaBtn), React.createElement('span', null, '→')), isEn ? React.createElement(VerifiedSeal, null) : null), React.createElement('figure', {
  ...
  const mainChildren = isEn ? [heroSection, proofSection, homePointSection, workSection, startSection] : [heroSection, homePointSection, amDualitySection, React.createElement('div', {
    className: 'home-flow',
    key: 'flow'
...
function AboutPageV2({
  ...
  if (isEn) {
    ...
    const bridgeSection = React.createElement('section', {
      className: 'ax-bridge',
      'aria-labelledby': 'ax-bridge-title',
      key: 'bridge'
    }, React.createElement('div', {
      className: 'ax-container'
    }, React.createElement('p', {
      className: 'ax-bridge__label'
    }, c.bridgeLabel), React.createElement('h2', {
      className: 'ax-bridge__h',
      id: 'ax-bridge-title'
    }, c.bridgeH), React.createElement('div', {
      className: 'ax-bridge__grid'
    }, React.createElement('div', {
      className: 'ax-bridge__copy'
    }, c.bridgeBody.map(function (t, i) {
      return React.createElement('p', {
        key: i
      }, t);
    }), React.createElement('p', {
      className: 'ax-bridge__close'
    }, c.bridgeClose)), React.createElement('ol', {
      className: 'ax-bridge__steps'
    }, c.bridgeSteps.map(function (b) {
      return React.createElement('li', {
        className: 'ax-bridge__step',
        key: b.n
      }, React.createElement('span', {
        className: 'ax-bridge__n'
      }, b.n), React.createElement('span', {
        className: 'ax-bridge__t'
      }, b.t));
    })))));
    ...
    const ctaSection = React.createElement('section', {
      ...
      className: 'ax-cta__h'
    }, 'If that sounds like the kind of thinking you want, here is how I work.'), React.createElement('a', {
