...
const WHY_V2 = {
  en: {
    ...
    ex: [{
      ...
      r: 'If the offer is good and you cannot bring yourself to sell it, I can work on that too.'
    }, {
      l: 'If a client relationship needs better pricing or clearer boundaries, we handle both.',
      r: 'If the same nice-guy pattern appears with your partner, we do not pretend it is unrelated.'
    }, {
      l: 'If you want a promotion, a side business or a different consultancy model, I can help you make the move.',
  ...
  el: {
    ...
    ex: [{
      ...
      r: 'Αν είναι καλό και δεν μπορείς να βγεις να το πουλήσεις, μπορώ να δουλέψω και αυτό.'
    }, {
      l: 'Αν μια σχέση με πελάτη χρειάζεται καλύτερη τιμολόγηση ή πιο καθαρά όρια, πιάνουμε και τα δύο.',
      r: 'Αν το ίδιο nice-guy pattern εμφανίζεται και με τον σύντροφό σου, δεν κάνουμε πως είναι άσχετο.'
    }, {
      l: 'Αν θέλεις προαγωγή, side business ή διαφορετικό μοντέλο για την consultancy σου, δουλεύουμε την κίνηση.',
...
function AboutPageV2({
  ...
  }, c.ex.map((row, i) => React.createElement('div', {
    className: 'amx-case',
    key: i
  }, React.createElement('p', {
    className: 'amx-body'
  }, row.l), React.createElement('p', {
    className: 'amx-body'
  }, row.r)))))),
  // One room — off-white
  React.createElement('section', {
