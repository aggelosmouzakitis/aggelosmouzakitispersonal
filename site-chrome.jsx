...
const CLARITY_LINKS = [
  { name: "What's limiting your business?", href: '/clarity-tools/business-constraint/', id: 'business-constraint' },
  { name: 'Is it a strategy or execution problem?', href: '/clarity-tools/strategy-or-execution/', id: 'strategy-or-execution' },
  { name: "What's making you want to quit your job?", href: '/clarity-tools/quit-your-job/', id: 'quit-your-job' },
  { name: 'Do you want to become a solopreneur?', href: '/clarity-tools/become-a-solopreneur/', id: 'become-a-solopreneur' },
  { name: 'Are you burned out?', href: '/clarity-tools/burned-out/', id: 'burned-out' },
];
