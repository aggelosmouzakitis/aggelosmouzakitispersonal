...
const CHROME_T = {
  en: {
    ...
    freeTools: 'Free tools', startHere: 'Not sure where to start?',
...
const FREE_TOOL_LINKS = [
  ...
  { name: "What's making you want to quit your job?", href: '/free-tools/quit-your-job/', id: 'quit-your-job', category: 'Career' },
  { name: 'Do you want to become a solopreneur?', href: '/free-tools/become-a-solopreneur/', id: 'become-a-solopreneur', category: 'Career' },
  { name: 'Are you burned out?', href: '/free-tools/burned-out/', id: 'burned-out', category: 'Psychology' },
];
  ...
  return React.createElement('section', { className: 'cta-strip' },
    React.createElement('div', { className: 'site-container' },
      ...
      isEn ? React.createElement('div', null,
        React.createElement('a', { className: 'cta-strip__soft', href: '/start-here/' },
        ...
        React.createElement('nav', null,
          ...
          lang === 'en'
            ? React.createElement(React.Fragment, null,
                React.createElement('a', { href: FREE_TOOLS_URL }, t.freeTools),
