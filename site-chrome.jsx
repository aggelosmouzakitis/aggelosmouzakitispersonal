...
const CHROME_T = {
  en: {
    ...
    start: 'START', other: 'Ελληνικά',
    role1: 'Business Growth Advisor', role2: 'Licensed Psychotherapist (BACP)',
    ...
    ctaBtn: 'Start here', menu: 'Menu', rights: 'All rights reserved.',
  },
  el: {
    home: 'Αρχική', why: 'Γιατί εμένα', reviews: 'Κριτικές', apply: 'Ζήτησε γνωριμία',
    start: 'ΞΕΚΙΝΑ', other: 'English',
    role1: 'Business Growth Advisor', role2: 'Ψυχοθεραπευτής (BACP)',
    ...
    ctaBtn: 'Ξεκίνα εδώ', menu: 'Μενού', rights: 'Με επιφύλαξη παντός δικαιώματος.',
  },
};
...
function Wordmark({ lang }) {
  return React.createElement('a', { className: 'site-hdr__mark', href: cPath('home', lang) },
    React.createElement('b', null, 'AGGELOS'),
    React.createElement('i', null),
    React.createElement('em', null, 'MOUZAKITIS')
  );
}
      ...
      React.createElement('div', { className: 'site-container site-hdr__in' },
        ...
        React.createElement('div', { style: { display: 'flex', alignItems: 'center', justifySelf: 'end' } },
          React.createElement('div', { className: 'site-hdr__end' },
            ...
            React.createElement('a', { className: 'pill pill--light', href: cPath('diagnostic', lang) },
    ...
    open && React.createElement('div', { className: 'site-menu' },
      React.createElement('div', { className: 'site-container' },
        ...
        React.createElement('a', {
          className: 'pill pill--green', href: cPath('diagnostic', lang),
  ...
  return React.createElement('footer', { className: 'site-ftr' },
    React.createElement('div', { className: 'site-container' },
      React.createElement('div', { className: 'site-ftr__cols' },
        React.createElement('div', null,
          React.createElement('div', { className: 'site-hdr__mark' },
            React.createElement('b', null, 'AGGELOS'),
            React.createElement('i', null),
            React.createElement('em', null, 'MOUZAKITIS')
          ),
...
function LegacyShell({ page, lang = 'en', children, form, wide, cta = true }) {
  const inner = form ? 'u-form' : (wide ? 'site-container' : 'u-read');
  return React.createElement(React.Fragment, null,
    React.createElement(ChromeStyles),
    React.createElement(SiteHeader, { page, lang }),
    React.createElement('main', null,
      React.createElement('section', { className: 'u-main', style: { paddingBlock: '64px 96px' } },
