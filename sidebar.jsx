...
function MobileNav({ page, lang }) {
  ...
  const tabStyle = (active) => ({
    ...
    color: active ? '#047857' : 'rgba(40,39,38,0.55)',
  ...
  return (
    <React.Fragment>
      ...
      <nav style={{
        ...
        <a style={{ ...tabStyle(act === 'diagnostic'), color: '#047857', fontWeight: 700 }} href={diagPath(lang)}><ICONS.Pulse /><span>{t.diagShort}</span></a>
      </nav>
    </React.Fragment>
  );
}
...
function Sidebar({ page, lang = 'en', open, setOpen }) {
  ...
  if (!open) return (
    <div style={{ width: SB.WC, minWidth: SB.WC, background: SB.bg, borderRight: `1px solid ${SB.border}`, height: '100vh', position: 'relative', flexShrink: 0, display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
      <ToggleBtn />
      <a href={homeHref}><img src="https://aggelosmouzakitis.com/img/aggelos-96.webp?v=3" alt="Aggelos Mouzakitis" width={38} height={38} style={{ width: 38, height: 38, borderRadius: '50%', objectFit: 'cover', margin: '22px 0 8px', display: 'block' }} /></a>
    ...
    <div style={{ width: SB.W, minWidth: SB.W, background: SB.bg, borderRight: `1px solid ${SB.border}`, height: '100vh', position: 'relative', flexShrink: 0, display: 'flex', flexDirection: 'column', overflow: 'visible' }}>
      ...
      <div style={{ flex: 1, overflowY: 'auto', overflowX: 'hidden', display: 'flex', flexDirection: 'column' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 12, padding: '22px 18px 20px', borderBottom: `1px solid ${SB.border}`, flexShrink: 0 }}>
          <a href={homeHref} style={{ display: 'flex', flexShrink: 0 }}><img src="https://aggelosmouzakitis.com/img/aggelos-96.webp?v=3" alt="Aggelos Mouzakitis" width={38} height={38} style={{ width: 38, height: 38, borderRadius: '50%', objectFit: 'cover', flexShrink: 0, display: 'block' }} /></a>
        ...
        <div style={{ padding: '0 16px 22px', flexShrink: 0 }}>
          <div style={{ border: `1.5px solid rgba(4, 120, 87,0.45)`, padding: '19px', background: 'rgba(4, 120, 87,0.08)' }}>
