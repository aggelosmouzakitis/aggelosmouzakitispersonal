...
window.CLARITY_DATA['business-constraint'] = {
  ...
  cta: { heading: 'Want another perspective?', sub: 'If you want a second read on which constraint to work on first, a working session goes through your specific numbers and situation in depth.', label: 'SEE HOW I WORK →', href: '/work-with-me/' },
  questions: [
...
window.CLARITY_DATA['strategy-or-execution'] = {
  ...
  cta: { heading: 'Want another perspective?', sub: 'If the result points at more than one driver, a working session can help you decide what to change first without guessing.', label: 'SEE HOW I WORK →', href: '/work-with-me/' },
  questions: [
...
window.CLARITY_DATA['become-a-solopreneur'] = {
  ...
  cta: { heading: 'Want another perspective?', sub: 'If fit and readiness are pointing in different directions, a working session can help you decide what to test before committing to anything.', label: 'SEE HOW I WORK →', href: '/work-with-me/' },
  breakdownGroups: [
