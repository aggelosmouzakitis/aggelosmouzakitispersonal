...
const HOME_OFFERS = [
  { name: 'Psychotherapy / decision coaching', desc: 'Think through the decision or pattern that keeps circling.', href: '/psychotherapy-decision-coaching/' },
  { name: 'Career strategy consulting', desc: 'Build a paid offer while you keep your job.', href: '/career-strategy-consulting/' },
  { name: 'Solo business growth consulting', desc: 'Grow the business without grinding yourself down.', href: '/solopreneur-growth-consulting/' },
];
const HOME_TOOLS = [
...
function HomePageV2({ lang = 'en' }) {
  ...
  const workSection = isEn ? React.createElement('section', { key: 'work' },
    React.createElement('div', { className: 'site-container' },
      React.createElement('div', { className: 'home-work' },
  ...
  const startSection = isEn ? React.createElement('section', { key: 'start' },
    React.createElement('div', { className: 'site-container' },
      SecLabel('02', 'Start here for free'),
      React.createElement('h2', { className: 'home-start__h' }, "You don't need to know what kind of help you need before you start."),
      React.createElement('div', { className: 'home-start__grid' },
        React.createElement('div', { className: 'home-start__col home-start__col--clarity' },
          React.createElement('div', { className: 'home-start__titlerow' },
            React.createElement('span', { className: 'home-start__name' }, 'Clarity tools'),
            React.createElement('span', { className: 'home-start__badge' }, '5 tools')
          ),
          React.createElement('span', { className: 'home-start__desc' }, "Short assessments to work out what's actually going on with your business, career, execution or burnout."),
        ...
        React.createElement('a', { className: 'home-start__col home-start__col--wtf', href: '/wtf-friday/', 'aria-label': 'Join WTF Friday' },
          React.createElement('span', { className: 'home-start__name' }, 'WTF Friday'),
          React.createElement('span', { className: 'home-start__desc' }, 'Free weekly office hours. Bring a real problem, get a real answer.'),
          React.createElement('span', { className: 'home-start__go' }, 'Join WTF Friday ', React.createElement('span', { 'aria-hidden': 'true' }, '→'))
        ),
        React.createElement('a', { className: 'home-start__col home-start__col--ask', href: window.cPath('ask-me-anything', lang), 'aria-label': 'Ask me something' },
          React.createElement('span', { className: 'home-start__name' }, 'Ask me something'),
          React.createElement('span', { className: 'home-start__desc' }, 'Send a question anonymously. I answer selected questions publicly.'),
          React.createElement('span', { className: 'home-start__go' }, 'Ask something ', React.createElement('span', { 'aria-hidden': 'true' }, '→'))
        ),
  ...
  const heroSection = React.createElement('section', { className: 'home-hero', key: 'hero' },
    React.createElement('div', { className: 'home-hero__grid' },
      React.createElement('div', { className: 'home-hero__copy' },
        ...
        React.createElement('a', { className: 'hero-cta', href: isEn ? '/start-here/' : window.cPath('diagnostic', lang) },
          React.createElement('span', null, isEn ? 'START HERE' : t.ctaBtn), React.createElement('span', null, '→'))
      ),
  ...
  const mainChildren = isEn
    ? [heroSection, React.createElement('div', { className: 'home-flow', key: 'flow' }, workSection, startSection)]
...
function AboutPageV2({ lang = 'en' }) {
  ...
  if (isEn) {
    ...
    const visualSection = React.createElement('section', { className: 'am-duality-section', 'aria-labelledby': 'about-duality-title', key: 'visual' },
      React.createElement('div', { className: 'am-duality-section__inner' },
        React.createElement('header', { className: 'am-duality-section__heading' },
          React.createElement('p', { className: 'amx-label' }, 'BUSINESS + PSYCHOLOGY'),
          React.createElement('h2', { className: 'am-duality-section__title', id: 'about-duality-title', style: { marginTop: 14 } }, 'Why I sit between two professional worlds.')
        ),
        React.createElement('div', { className: 'am-duality' },
          React.createElement('article', { className: 'am-duality__side am-duality__side--business' },
            React.createElement('div', { className: 'am-duality__copy' },
              React.createElement('p', { className: 'am-duality__label' }, 'Business'),
              React.createElement('p', { className: 'am-duality__statement' }, 'I spent most of my career here.')
            )
          ),
          React.createElement('article', { className: 'am-duality__side am-duality__side--psychology' },
            React.createElement('div', { className: 'am-duality__copy' },
              React.createElement('p', { className: 'am-duality__label' }, 'Psychology'),
              React.createElement('p', { className: 'am-duality__statement' }, 'I trained here because business knowledge was not enough.')
            )
          ),
          React.createElement('figure', { className: 'am-duality__portrait' },
            React.createElement('img', { src: '/img/aggelos-overlap.webp?v=2', alt: 'Aggelos Mouzakitis', width: 250, height: 426, loading: 'lazy', decoding: 'async' })
    ...
    const explainSection = React.createElement('section', { className: 'amx-paper amx-section', key: 'explain' },
      React.createElement('div', { className: 'amx-container' },
        React.createElement('div', { className: 'amx-reading-copy' },
          React.createElement('p', { className: 'amx-body' }, 'Most problems I work on do not stay neatly on one side.'),
          React.createElement('p', { className: 'amx-body' }, 'A pricing problem can involve fear of rejection. A career decision can be commercially rational and psychologically difficult. A business can have the right strategy and an owner who keeps avoiding it.'),
          React.createElement('p', { className: 'amx-body' }, 'That is why I work with both.')
        )
      )
    );

    const whySection = React.createElement('section', { className: 'amx-dark amx-section', key: 'why' },
      React.createElement('div', { className: 'amx-container' },
        React.createElement('div', { className: 'amx-section-head' },
          React.createElement('h2', { className: 'amx-heading' }, 'Why I ended up here')
        ),
        React.createElement('div', { className: 'amx-reading-copy' },
          React.createElement('p', { className: 'amx-body' }, 'I built a consultancy, worked with more than 100 technology companies and built two startups that failed. For years, being useful, reasonable and easy to work with helped me professionally. It also made it easier to avoid conflict, accept things I did not want and stay too long in the wrong places.'),
          React.createElement('p', { className: 'amx-body' }, 'Knowing more about business did not explain why approval, fear or other people’s reactions could still influence decisions that looked perfectly rational on paper. That gap is part of why I trained as a psychotherapist.'),
          React.createElement('p', { className: 'amx-body' }, 'Today I work with both sides of the problem when both sides matter.')
        )
      )
    );

    const ctaSection = React.createElement('section', { className: 'amx-dark amx-section amx-final', key: 'cta' },
      React.createElement('div', { className: 'amx-container' },
        React.createElement('a', { className: 'amx-button', href: '/start-here/' }, 'START HERE →')
      )
    );
  ...
  return React.createElement(React.Fragment, null,
    ...
    React.createElement('main', { className: 'amx-page amx-page--about' }, aboutMainChildren),
    React.createElement(window.SiteFooterX, { lang })
  );
}
