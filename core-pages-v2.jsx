...
const HOME_V2 = {
  en: {
    ...
    points: [
      { label: '01 / EXPERIENCE', lead: 'I did the work before I started selling advice.',
      ...
      { label: '02 / TRAINING', lead: 'I am not just a guy with too much confidence.',
      ...
      { label: '03 / HOW I WORK', lead: 'Years in consumer psychology changed the way I read problems.',
...
function HeroField() {
  ...
  return React.createElement('svg', {
    ...
    React.createElement('defs', null,
      React.createElement('linearGradient', { id: 'hfFade', gradientUnits: 'userSpaceOnUse', x1: 520, y1: 0, x2: 980, y2: 0 },
        React.createElement('stop', { offset: '0', stopColor: '#171919', stopOpacity: '0' }),
        React.createElement('stop', { offset: '1', stopColor: '#171919', stopOpacity: '0.11' })),
      React.createElement('linearGradient', { id: 'hfFadeM', gradientUnits: 'userSpaceOnUse', x1: 0, y1: 0, x2: 390, y2: 0 },
        React.createElement('stop', { offset: '0', stopColor: '#171919', stopOpacity: '0' }),
        React.createElement('stop', { offset: '0.35', stopColor: '#171919', stopOpacity: '0.08' }),
        React.createElement('stop', { offset: '1', stopColor: '#171919', stopOpacity: '0.08' }))),
    React.createElement('g', { ref: ref('field') },
      React.createElement('g', { className: 'home-hero__field-d' },
        lines.map(function (y) {
          return React.createElement('line', { key: 'l' + y, x1: 520, y1: y, x2: 1440, y2: y, stroke: 'url(#hfFade)', strokeWidth: 1 });
        }),
        React.createElement('line', { x1: 520, y1: 604, x2: 1440, y2: 604, stroke: 'url(#hfFade)', strokeWidth: 1 }),
        React.createElement('line', { ref: ref('trail'), x1: 700, y1: 604, x2: 700, y2: 604, stroke: '#047857', strokeWidth: 1.25, opacity: 0.7 }),
        React.createElement('line', { ref: ref('drop'), x1: 950.4, y1: 604, x2: 950.4, y2: 604, stroke: '#047857', strokeWidth: 1.5 }),
        React.createElement('rect', { ref: ref('sq'), x: 695, y: 599, width: 10, height: 10, fill: '#047857' })),
      React.createElement('g', { className: 'home-hero__field-m' },
        linesM.map(function (y) {
          return React.createElement('line', { key: 'm' + y, x1: 0, y1: y, x2: 390, y2: y, stroke: 'url(#hfFadeM)', strokeWidth: 1 });
        }),
        React.createElement('line', { ref: ref('trailM'), x1: 60, y1: 372, x2: 60, y2: 372, stroke: '#047857', strokeWidth: 1.25, opacity: 0.7 }),
        React.createElement('rect', { ref: ref('sqM'), x: 56, y: 368, width: 8, height: 8, fill: '#047857' })))
  );
}
...
function FreeDisc(props) {
  ...
  React.useEffect(function () {
    const M = window.Motion, el = ref.current;
    if (!el || !M) return;
    M.track(el, {
      from: 1, to: 0,
      onProgress: function (p) { el.style.setProperty('--free-disc', (0.86 * 120 * p).toFixed(1) + 'px'); },
    });
    return function () { M.release(el); };
  }, []);
  return React.createElement('section', { className: 'home-free', ref: ref }, props.children);
}
  ...
  React.useEffect(function () {
    ...
    function apply(p) {
      ...
      const S = HOME_SHIFTS.map(function (_, i) {
        return mobile
          ? M.win(p, 0.24 + i * 0.19, 0.2, M.travel)
          : M.win(p, 0.3 + i * 0.16, 0.22, M.travel);
      });
      const anyStarted = S.some(function (s) { return s > 0; });
      const done = S.reduce(function (a, b) { return a + b; }, 0) / S.length;
    ...
    M.track(el, { from: 0.88, to: 0.45, onProgress: apply });
    return function () { M.release(el); };
  }, []);

  const cell = function (sh, i) {
    return React.createElement('div', {
      className: 'pfield__row', key: sh.n,
      ref: function (n) { rows.current[i] = n; },
    },
      React.createElement('div', { className: 'pfield__now' },
        React.createElement('span', { className: 'pfield__n' }, sh.n),
        React.createElement('span', { className: 'pfield__a' }, sh.a)),
      React.createElement('div', { className: 'pfield__track', 'aria-hidden': 'true' },
        React.createElement('span', { className: 'pfield__dash' }),
        React.createElement('span', { className: 'pfield__trail' }),
        React.createElement('span', { className: 'pfield__tick' }),
        React.createElement('span', { className: 'pfield__marker' })),
      React.createElement('div', { className: 'pfield__next' },
        React.createElement('span', { className: 'pfield__b' }, sh.b))
    );
  };

  return React.createElement('div', { className: 'pfield', ref: root },
    React.createElement('span', { className: 'pfield__wash', 'aria-hidden': 'true' }),
    React.createElement('span', { className: 'pfield__toprule', 'aria-hidden': 'true' }),
    React.createElement('div', { className: 'pfield__head', ref: head },
      React.createElement('span', { className: 'pfield__headlabel' }, 'What\u2019s happening now'),
      React.createElement('span', { className: 'pfield__headtrack', 'aria-hidden': 'true' },
        React.createElement('span', { className: 'pfield__headline' }),
        React.createElement('span', { className: 'pfield__headarrow' }, '\u2192')),
      React.createElement('span', { className: 'pfield__headlabel pfield__headlabel--next' }, 'What you want instead')),
    HOME_SHIFTS.map(cell),
    React.createElement('span', { className: 'pfield__foot', 'aria-hidden': 'true' })
  );
}
...
function HomePageV2({ lang = 'en' }) {
  ...
  const proofSection = isEn ? React.createElement('section', { className: 'home-proof', key: 'proof' },
    React.createElement('span', { className: 'home-proof__carry', 'aria-hidden': 'true' }),
  ...
  const workSection = isEn ? React.createElement('section', { className: 'home-work', key: 'work', 'data-handoff': 'light' },
    React.createElement('div', { className: 'site-container' },
      ...
      React.createElement(ProgressField, null),
  ...
  const startSection = isEn ? React.createElement(FreeDisc, { key: 'start' },
    React.createElement('div', { className: 'site-container' },
      ...
      React.createElement('a', { className: 'home-free__feature', href: window.FOCUS_AREA_URL || '/find-your-focus-area/' },
        React.createElement('span', null,
          React.createElement('span', { className: 'home-free__tool-tags' },
            React.createElement('span', { className: 'home-free__tool-free' }, 'Free'),
            React.createElement('span', { className: 'home-free__tool-kind' }, 'Assessment · 4 minutes')),
          React.createElement('span', { className: 'home-free__feature-name' }, 'Find Your Focus Area'),
          React.createElement('span', { className: 'home-free__feature-sub' }, 'A 4-minute assessment to find what deserves your attention first.')),
        React.createElement('span', { className: 'home-free__feature-go' },
          React.createElement('span', null, 'Start the assessment'), React.createElement('span', { 'aria-hidden': 'true' }, '\u2192'))),
  ...
  const heroSection = React.createElement('section', { className: 'home-hero', key: 'hero' },
    isEn ? React.createElement(HeroField, null) : null,
      ...
      React.createElement('div', { className: 'home-hero__copy' },
        ...
        isEn
          ? React.createElement('div', { className: 'home-hero__ctarow' },
              React.createElement('a', { className: 'hero-cta hero-cta--caps', href: window.FOCUS_AREA_URL || '/find-your-focus-area/' },
                React.createElement('span', null, 'Free assessment'), React.createElement('span', { 'aria-hidden': 'true' }, '→')),
  ...
  if (isEn) {
    ...
    const ctaSection = React.createElement('section', { className: 'ax-cta', key: 'cta' },
      React.createElement('div', { className: 'ax-container' },
        ...
        React.createElement('a', { className: 'ax-cta__soft', href: '/free-tools/' }, 'Explore all free tools →')
      )
    );
