...
function HomePageV2({ lang = 'en' }) {
  ...
  return React.createElement(React.Fragment, null,
    ...
    React.createElement('main', null,
      ...
      React.createElement('section', { className: 'home-point' },
        React.createElement('div', { className: 'site-container' },
          React.createElement('div', { className: 'home-point__inner' },
            ...
            React.createElement('div', { className: 'home-point__grid' },
              arr(c.points).map((pt, i) =>
                React.createElement('article', { className: 'home-point__card home-point__card--' + (i + 1), key: i },
                  ...
                  React.createElement('div', { className: 'home-point__text' },
                    arr(pt.body).map((b, j) => React.createElement('p', { className: 'home-point__body', key: j }, b)),
            ...
            React.createElement('div', { className: 'home-point__logos' },
              ...
              React.createElement('div', { className: 'home-point__logos-row' },
                ['IBM', 'Farfetch', 'GrowthMentor', 'Discover Greece', 'University of London', 'University of Oxford', 'Glofox', 'Whereby', 'Octopus Investments', 'Startupbootcamp', 'Advantage Austria', 'How to Web', 'Moosend'].map((name, i) =>
                  React.createElement('span', { className: 'home-point__logo', key: i }, name)
                )
              )
            )
          )
...
function AboutPageV2({ lang = 'en' }) {
  ...
  return React.createElement(React.Fragment, null,
    ...
    React.createElement('main', { className: 'amx-page amx-page--about' },
