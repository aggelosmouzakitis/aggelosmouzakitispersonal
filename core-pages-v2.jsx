...
const HOME_V2 = {
  en: {
    ...
    points: [
      { label: '01 / BUSINESS', lead: 'I did the work before I started selling advice.',
      ...
      { label: '02 / CAREER', lead: 'I built my own career before advising anyone on theirs.',
      ...
      { label: '03 / TRAINING', lead: 'I am not just a guy with too much confidence.',
      ...
      { label: '04 / REACH', lead: 'I am not a social media personality or an influencer.',
      ...
      { label: '05 / BUSINESS → PSYCHOLOGY', lead: 'You do not have to leave the psychological part out.',
        body: ['If you come for business advisory, you also get the psychological work that often matters more than the strategy.'] },
      { label: '06 / PSYCHOLOGY → BUSINESS', lead: 'You do not have to leave the business context out.',
  ...
  el: {
    ...
    points: [
      { label: '01 / BUSINESS', lead: 'Έκανα τη δουλειά πριν αρχίσω να πουλάω συμβουλές.',
      ...
      { label: '02 / ΚΑΡΙΕΡΑ', lead: 'Έχτισα τη δική μου καριέρα πριν αρχίσω να συμβουλεύω άλλους για τη δική τους.',
      ...
      { label: '03 / ΕΚΠΑΙΔΕΥΣΗ', lead: 'Δεν είμαι απλά ένας τύπος με υπερβολική αυτοπεποίθηση.',
      ...
      { label: '04 / REACH', lead: 'Δεν είμαι social media personality ή influencer.',
      ...
      { label: '05 / BUSINESS → ΨΥΧΟΛΟΓΙΑ', lead: 'Δεν χρειάζεται να αφήσεις το ψυχολογικό κομμάτι απ’ έξω.',
      ...
      { label: '06 / ΨΥΧΟΛΟΓΙΑ → BUSINESS', lead: 'Δεν χρειάζεται να αφήσεις το business κομμάτι απ’ έξω.',
...
const HOME_TOOLS = [
  { name: "What's limiting your business?", href: '/clarity-tools/business-constraint/' },
  { name: 'Is it a strategy or execution problem?', href: '/clarity-tools/strategy-or-execution/' },
  { name: "What's making you want to quit your job?", href: '/clarity-tools/quit-your-job/' },
  { name: 'Do you want to become a solopreneur?', href: '/clarity-tools/become-a-solopreneur/' },
  { name: 'Are you burned out?', href: '/clarity-tools/burned-out/' },
];
...
.home-flow .sec-label__desc{color:#8FBFA7}
...
.home-hero__title::after{content:"";display:block;width:96px;height:1px;background:${V2.green};margin:22px 0 22px}
.home-hero__title .home-hero__line{display:block}
html[lang="en"] .home-hero__title{font-size:clamp(40px,4.4vw,58px);text-wrap:balance}
...
.home-hero__title .human{position:relative;z-index:0;white-space:nowrap;color:${V2.green}}
.home-hero__title .human::after{content:none}
...
.home-point{position:relative;overflow:clip;width:100%;background:#EDE8DB}
.home-point::before{content:"";position:absolute;top:-140px;right:-130px;width:420px;height:420px;border-radius:50%;background:rgba(4,120,87,0.06);pointer-events:none}
.home-point__inner{position:relative;padding-block:clamp(64px,8vw,96px)}
.home-point__eyebrow{font-family:${V2.archivo};font-synthesis:none;font-size:13px;font-weight:400;line-height:1;letter-spacing:0.10em;text-transform:uppercase;color:#047857}
.home-point__h{margin:20px 0 clamp(44px,5vw,72px);max-width:24ch;font-family:${V2.display};font-synthesis:none;font-size:clamp(40px,4.4vw,60px);font-weight:800;line-height:1;letter-spacing:-0.04em;color:#14201C;text-wrap:balance}
...
.home-point__card{height:100%;padding:clamp(28px,2.6vw,36px);border-radius:0;border:1px solid rgba(23,25,25,0.12);display:flex;flex-direction:column;color:#171919}
.home-point__label{font-family:${V2.archivo};font-synthesis:none;font-size:13px;font-weight:400;line-height:1;letter-spacing:0.08em;text-transform:uppercase;color:#047857}
.home-point__rule{height:1px;margin:14px 0 22px;background:rgba(23,25,25,0.24)}
...
.home-point__body{margin:0;font-size:17px;line-height:1.55;color:#3A403A;text-wrap:pretty}
.home-point__close{margin:0;font-size:17px;line-height:1.55;font-weight:600;color:#171919;text-wrap:pretty}
.home-point__card--1{background:#F3F0E8}
.home-point__card--2{background:#F3F0E8}
.home-point__card--3{background:#F3F0E8}
.home-point__card--4{background:#16231E;border-color:transparent;color:${V2.white}}
.home-point__card--4 .home-point__label{color:#8FBFA7}
.home-point__card--4 .home-point__rule{background:rgba(243,240,232,0.3)}
.home-point__card--4 .home-point__lead{color:${V2.white}}
.home-point__card--4 .home-point__body{color:#C0C9BF}
.home-point__card--4 .home-point__close{color:${V2.white}}
.home-point__card--5{background:#F3F0E8}
.home-point__card--6{background:#F3F0E8}
.home-point__logos{margin-top:clamp(56px,7vw,92px)}
.home-point__logos-label{font-family:${V2.archivo};font-synthesis:none;font-size:13px;font-weight:400;line-height:1;letter-spacing:0.10em;color:#047857;text-transform:uppercase}
.home-point__logos-row{margin-top:34px;display:flex;flex-wrap:wrap;align-items:center;gap:24px 48px}
.home-point__logo{font-family:${V2.display};font-synthesis:none;font-size:20px;font-weight:700;line-height:1.1;letter-spacing:-0.01em;color:#6A6F67;white-space:nowrap}
...
.am-duality-section__title{max-width:880px;margin:0;font-family:${V2.display};font-synthesis:none;font-size:clamp(43px,4.25vw,61px);line-height:0.98;letter-spacing:-0.052em;font-weight:800;color:#171919}
...
.am-duality__side--business{padding:52px 160px 52px 50px;background:#16231E;color:#F3F0E8}
.am-duality__side--psychology{padding:52px 50px 52px 180px;background:#047857;color:#F3F0E8;text-align:right}
...
.am-duality__portrait{position:absolute;z-index:3;left:50%;top:50%;width:var(--am-photo-width);height:var(--am-photo-height);margin:0;transform:translate(-50%,-50%);overflow:hidden;background:#16231E}
.am-duality__portrait img{display:block;width:100%;height:100%;object-fit:cover;object-position:50% 20%;filter:grayscale(1) contrast(1.12) brightness(0.96) sepia(0.14)}
...
.sec__h{margin:0 0 48px;max-width:19ch;font-family:${V2.display};font-size:clamp(40px,4.25vw,58px);font-weight:800;line-height:0.98;letter-spacing:-0.045em;color:#F3F0E8;text-wrap:balance}
.sec__h2l{margin:0 0 48px;font-family:${V2.display};font-size:clamp(52px,5.5vw,76px);font-weight:800;line-height:0.94;letter-spacing:-0.045em;color:#F3F0E8}
.sec__h2l span{display:block}
.opinion{display:grid;grid-template-columns:0.85fr 1.15fr;background:${V2.white};border-radius:0;overflow:hidden}
...
.cont{min-height:440px;background:${V2.white};border-radius:0;padding:clamp(32px,5vw,72px);display:flex;align-items:center}
...
.media{display:grid;grid-template-columns:7fr 5fr;grid-template-rows:repeat(2,minmax(0,1fr));min-height:520px;border-radius:0;overflow:hidden}
...
.media__read{grid-row:1 / span 2;background:${V2.green};color:#F3F0E8}
.media__read:hover{background:${V2.greenPressed}}
.media__read h3{font-size:clamp(64px,6vw,92px)}
.media__watch{background:${V2.forest};color:#F3F0E8}
.media__watch:hover{background:${V2.forestDeep}}
...
.amx-button{min-height:48px;display:inline-flex;align-items:center;justify-content:center;padding-inline:21px;border:0;border-radius:0;color:#F3F0E8;background:var(--am-green);font:600 16px/1 var(--font-body);text-decoration:none}
...
.amx-final-link{display:block;margin-top:18px;color:#6A6F67;font:400 13px/1.4 var(--font-body)}
...
.rev-avatar__img{position:absolute;inset:0;width:100%;height:100%;object-fit:cover;filter:grayscale(1) contrast(1.12) brightness(0.96) sepia(0.14)}
...
.ax-container{position:relative;width:min(100%,1080px);margin-inline:auto;padding-inline:clamp(24px,5vw,56px)}
.ax-label{margin:0;color:${V2.green};font:700 13px/1.3 ${V2.body};letter-spacing:0.09em;text-transform:uppercase}
.ax-top{position:relative;overflow:clip;background:${V2.paper}}
.ax-top::before{content:"";position:absolute;top:-160px;right:-120px;width:460px;height:460px;border-radius:50%;background:rgba(4,120,87,0.08);pointer-events:none}
.ax-hero{padding-block:clamp(64px,8vw,96px) 0}
.ax-hero__h{position:relative;max-width:18ch;margin-top:20px;font-family:${V2.archivo};font-synthesis:none;font-size:clamp(34px,5vw,56px);font-weight:400;line-height:1.02;letter-spacing:-0.035em;color:#14201C;text-wrap:balance}
.ax-hero__h::after{content:"";display:block;width:110px;height:1px;background:${V2.green};margin:28px 0 0}
.ax-hero__deck{position:relative;max-width:68ch;margin-top:24px;font-size:19px;line-height:1.62;color:#2C312C;text-wrap:pretty}
.ax-cred{padding-block:clamp(40px,5vw,56px) clamp(64px,8vw,96px)}
.ax-cred__head{max-width:750px;padding-top:clamp(40px,5vw,56px);border-top:1px solid rgba(23,25,25,0.20)}
...
.ax-duality__side--business{background:#16231E;color:#F3F0E8}
.ax-duality__side--psychology{background:${V2.green};color:#F3F0E8}
.ax-duality__side--psychology .ax-duality__k{color:#CFE6DA}
.ax-duality__k{margin:0;font-size:13px;font-weight:800;line-height:1;letter-spacing:0.075em;text-transform:uppercase}
.ax-duality__side--business .ax-duality__k{color:#8FBFA7}
...
.ax-duality__img{display:block;width:100%;height:100%;min-height:300px;object-fit:cover;object-position:50% 20%;filter:grayscale(1) contrast(1.12) brightness(0.96) sepia(0.14);background:#16231E}
...
.ax-why{position:relative;overflow:clip;background:${V2.ink};color:#EDE8DB;padding-block:clamp(64px,8vw,96px)}
.ax-why::before{content:"";position:absolute;top:-140px;left:-160px;width:480px;height:480px;border-radius:50%;background:rgba(143,191,167,0.07);pointer-events:none}
...
.ax-why__rule{width:min(240px,60%);height:1px;background:#8FBFA7}
.ax-why__h{max-width:14ch;margin-top:24px;font-family:${V2.display};font-synthesis:none;font-size:clamp(32px,4vw,46px);font-weight:800;line-height:1.02;letter-spacing:-0.04em;color:#F3F0E8;text-wrap:balance}
.ax-why__body{display:flex;flex-direction:column;gap:22px;max-width:60ch}
.ax-why__body p{margin:0;font-size:18px;line-height:1.66;color:#C8D1C8;text-wrap:pretty}
.ax-why__quote{margin:6px 0 0;padding-left:24px;border-left:2px solid #8FBFA7;font-family:${V2.display};font-size:22px;font-weight:700;line-height:1.28;letter-spacing:-0.025em;color:#F3F0E8;text-wrap:pretty}
...
function HomePageV2({ lang = 'en' }) {
  ...
  const titleLine1 = rotWords
    ? React.createElement('span', { className: 'home-hero__line' },
        c.titleRotatePre,
        React.createElement('span', { className: 'home-hero__rotate', 'aria-hidden': 'true' },
          React.createElement('span', { className: 'home-hero__rotate-sizer' }, rotWide + c.titleRotatePost),
          React.createElement('span', { className: 'home-hero__rotate-word home-hero__rotate-word--a' }, rotWords[0] + c.titleRotatePost),
          React.createElement('span', { className: 'home-hero__rotate-word home-hero__rotate-word--b' }, rotWords[1] + c.titleRotatePost)
        ),
        React.createElement('span', { className: 'home-hero__rotate-sr' }, rotWords[0] + c.titleRotatePost)
      )
  ...
  const heroTitleChildren = c.titleOneLine
    ? [React.createElement('span', { className: 'home-hero__line', key: 'one' },
        c.titleL1 + ' ',
        React.createElement('span', { className: 'human' }, c.titleHuman),
        c.titleL2post)]
    : [titleLine1,
       React.createElement('span', { className: 'home-hero__line', key: 'two' },
        c.titleL2pre,
        React.createElement('span', { className: 'human' }, c.titleHuman),
        c.titleL2post)];
  ...
  const clarityOpen = clarityState[0], setClarityOpen = clarityState[1];
  ...
  React.useEffect(function () {
    ...
    if (clarityOpen && clarityFirstRef.current) { try { clarityFirstRef.current.focus(); } catch (e) {} }
  }, [clarityOpen]);
  React.useEffect(function () {
    function onKey(ev) {
      if (ev.key === 'Escape' && clarityOpen) {
        setClarityOpen(false);
        if (clarityBtnRef.current) { try { clarityBtnRef.current.focus(); } catch (e) {} }
      }
    }
  ...
  const proofSection = isEn ? React.createElement('section', { className: 'home-proof', key: 'proof' },
    React.createElement('div', { className: 'site-container' },
      React.createElement('div', { className: 'home-proof__grid' },
        [['18+ years', ' in product and growth'], ['100+', ' technology companies advised'], ['MSc', ' Integrative Counselling & Psychotherapy'], ['BACP', ' registered psychotherapist']].map(function (p, i) {
          return React.createElement('p', { className: 'home-proof__item', key: i }, React.createElement('strong', null, p[0]), p[1]);
        })
      )
    )
  ) : null;
  ...
  const startSection = isEn ? React.createElement('section', { className: 'home-free', key: 'start' },
    React.createElement('div', { className: 'site-container' },
      SecLabel('02', 'Start here for free'),
      React.createElement('h2', { className: 'home-free__h' }, "You don't need to know what kind of help you need before you start."),
      React.createElement('div', { className: 'home-free__grid' },
        React.createElement('div', { className: 'home-free__col home-free__col--clarity' },
          React.createElement('div', { className: 'home-free__titlerow' },
            React.createElement('span', { className: 'home-free__name' }, 'Clarity tools'),
            React.createElement('span', { className: 'home-free__badge' }, '5 tools')
          ),
          React.createElement('span', { className: 'home-free__desc' }, 'Five short diagnostics that name the problem before you spend money solving the wrong one.'),
          React.createElement('button', {
            type: 'button', className: 'home-clarity__btn', ref: clarityBtnRef,
            'aria-expanded': clarityOpen ? 'true' : 'false', 'aria-controls': 'home-clarity-panel',
            onClick: function () { setClarityOpen(function (v) { return !v; }); },
          },
            React.createElement('span', null, clarityOpen ? 'Hide tools' : 'Choose a tool'),
            React.createElement('svg', { className: 'home-clarity__caret', viewBox: '0 0 10 6', width: 11, height: 7, 'aria-hidden': 'true' },
        ...
        React.createElement('a', { className: 'home-free__col home-free__col--wtf', href: '/wtf-friday/', 'aria-label': 'Join WTF Friday' },
          React.createElement('span', { className: 'home-free__name' }, 'WTF Friday'),
          React.createElement('span', { className: 'home-free__desc' }, 'Free weekly office hours. Bring one real problem, leave with a straight answer.'),
          React.createElement('span', { className: 'home-free__go' }, 'Join WTF Friday ', React.createElement('span', { 'aria-hidden': 'true' }, '→'))
        ),
        React.createElement('a', { className: 'home-free__col home-free__col--ask', href: window.cPath('ask-me-anything', lang), 'aria-label': 'Ask me something' },
          React.createElement('span', { className: 'home-free__name' }, 'Ask me something'),
          React.createElement('span', { className: 'home-free__desc' }, "Ask the thing you wouldn't put your name on. I answer selected ones publicly."),
          React.createElement('span', { className: 'home-free__go' }, 'Ask something ', React.createElement('span', { 'aria-hidden': 'true' }, '→'))
        )
      ),
      React.createElement('div', { id: 'home-clarity-panel', className: 'home-clarity-panel' + (clarityOpen ? ' is-open' : '') },
        React.createElement('div', { className: 'home-clarity-panel__inner' },
          React.createElement('div', { className: 'home-clarity-panel__list', ref: clarityListRef },
            HOME_TOOLS.map(function (tool, i) {
              return React.createElement('a', { key: tool.href, className: 'home-clarity__tool', href: tool.href, ref: i === 0 ? clarityFirstRef : null },
                React.createElement('span', null, tool.name),
                React.createElement('span', { className: 'home-clarity__tool-arw', 'aria-hidden': 'true' }, '→')
              );
            })
          )
        )
  ...
  const opinionSection = React.createElement('section', { key: 'opinion' },
    React.createElement('div', { className: 'site-container' },
      SecLabel(isEn ? '03' : '02', c.s02d),
      ...
      React.createElement('div', { className: 'opinion' },
        ...
        React.createElement('div', { className: 'opinion__body' },
          c.opinionParas.map(function (p, i) { return React.createElement('p', { key: i }, p); }),
  ...
  const contSection = React.createElement('section', { key: 'cont' },
    React.createElement('div', { className: 'site-container' },
      React.createElement('div', { className: 'cont' },
        React.createElement('div', { className: 'cont__in' },
          SecLabel(isEn ? '04' : '03', c.s03d),
  ...
  const moreSection = isEn ? React.createElement('section', { key: 'more' },
    React.createElement('div', { className: 'site-container' },
      React.createElement('div', { className: 'home-more__label' }, 'More from me'),
      React.createElement('div', { className: 'home-more__links' },
        React.createElement('a', { className: 'home-more__link', href: window.EXTERNAL.undisguised, ...v2Ext },
          React.createElement('span', { className: 'home-more__link-main' },
            React.createElement('span', { className: 'home-more__link-kicker' }, 'Undisguised'),
            React.createElement('span', { className: 'home-more__link-desc' }, c.readP)
          ),
          React.createElement('span', { className: 'home-more__link-arw', 'aria-hidden': 'true' }, '↗')
        ),
        React.createElement('a', { className: 'home-more__link', href: window.EXTERNAL.youtube, ...v2Ext },
          React.createElement('span', { className: 'home-more__link-main' },
            React.createElement('span', { className: 'home-more__link-kicker' }, 'YouTube'),
            React.createElement('span', { className: 'home-more__link-desc' }, c.watchP)
          ),
          React.createElement('span', { className: 'home-more__link-arw', 'aria-hidden': 'true' }, '↗')
        )
      )
    )
  ) : React.createElement('section', { key: 'more' },
    React.createElement('div', { className: 'site-container' },
      SecLabel('04', c.s04d),
      ...
      React.createElement('div', { className: 'media' },
        ...
        React.createElement('a', lang === 'el'
          ? { className: 'media__cell media__ask', href: 'https://www.videoask.com/fuv51iuq1', ...v2Ext }
          : { className: 'media__cell media__ask', href: window.cPath('ask-me-anything', lang) },
          React.createElement('div', { className: 'media__top' },
  ...
  const heroSection = React.createElement('section', { className: 'home-hero', key: 'hero' },
    React.createElement('div', { className: 'home-hero__grid' },
      React.createElement('div', { className: 'home-hero__copy' },
        ...
        React.createElement('h1', { className: 'home-hero__title' }, heroTitleChildren),
        React.createElement('p', { className: 'home-hero__support' }, c.support),
        isEn
          ? React.createElement('div', { className: 'home-hero__ctarow' },
              React.createElement('a', { className: 'hero-cta', href: '/start-here/' },
                React.createElement('span', null, 'Start here'), React.createElement('span', null, '→')),
              React.createElement('a', { className: 'home-hero__who', href: '/about/' },
                React.createElement('span', null, 'Who I am'), React.createElement('span', { 'aria-hidden': 'true' }, '→'))
            )
  ...
  const homePointSection = React.createElement('section', { className: 'home-point', key: 'point' },
    React.createElement('div', { className: 'site-container' },
      React.createElement('div', { className: 'home-point__inner' },
        React.createElement('div', { className: 'home-point__eyebrow' }, c.pointEyebrow),
        React.createElement('h2', { className: 'home-point__h' }, c.pointH),
        React.createElement('div', { className: 'home-point__grid' },
          arr(c.points).map(function (pt, i) {
            return React.createElement('article', { className: 'home-point__card home-point__card--' + (i + 1), key: i },
              React.createElement('div', { className: 'home-point__label' }, pt.label),
              React.createElement('div', { className: 'home-point__rule' }),
              React.createElement('p', { className: 'home-point__lead' }, pt.lead),
              React.createElement('div', { className: 'home-point__text' },
                arr(pt.body).map(function (b, j) { return React.createElement('p', { className: 'home-point__body', key: j }, b); }),
                pt.close ? React.createElement('p', { className: 'home-point__close' }, pt.close) : null
              )
            );
          })
        ),
        React.createElement('div', { className: 'home-point__logos' },
          React.createElement('div', { className: 'home-point__logos-label' }, c.logoLabel),
          React.createElement('div', { className: 'home-point__logos-row' },
            ['IBM', 'Farfetch', 'GrowthMentor', 'Discover Greece', 'University of London', 'University of Oxford', 'Glofox', 'Whereby', 'Octopus Investments', 'Startupbootcamp', 'Advantage Austria', 'How to Web', 'Moosend'].map(function (name, i) {
              return React.createElement('span', { className: 'home-point__logo', key: i }, name);
            })
          )
        )
      )
  ...
  const amDualitySection = React.createElement('section', { className: 'am-duality-section', 'aria-labelledby': 'am-duality-title', key: 'duality' },
  ...
  const finalCta = React.createElement(window.BlackCtaStrip, { lang, heading: c.finalH });
  ...
  const mainChildren = isEn
    ? [heroSection, proofSection, homePointSection, workSection, startSection]
    : [heroSection, homePointSection, amDualitySection,
       React.createElement('div', { className: 'home-flow', key: 'flow' }, opinionSection, contSection, moreSection),
       finalCta];
  ...
  return React.createElement(React.Fragment, null,
    ...
    React.createElement('main', null, mainChildren),
...
function AboutPageV2({ lang = 'en' }) {
  ...
  const heroSection = React.createElement('section', { className: 'amx-paper', key: 'hero' },
  ...
  const credOrFact = c.background
    ? React.createElement('section', { className: 'amx-paper amx-cred-section', key: 'cred' },
    ...
    : React.createElement('section', { className: 'amx-green amx-fact-bar', key: 'fact' },
        React.createElement('div', { className: 'amx-container' },
  ...
  if (isEn) {
    ...
    const credCol = function (col) {
      return React.createElement('div', { key: col.label },
        React.createElement('p', { className: 'ax-label' }, col.label),
        React.createElement('ul', { className: 'ax-cred__list' },
          col.items.map(function (it, i) {
            return React.createElement('li', { className: 'ax-cred__item', key: i },
              React.createElement('span', { className: 'ax-cred__t' }, it.t),
              it.m ? React.createElement('span', { className: 'ax-cred__m' }, it.m) : null
            );
          })
        )
      );
    ...
    const topSection = React.createElement('section', { className: 'ax-top', key: 'top' },
      React.createElement('div', { className: 'ax-container ax-hero' },
        React.createElement('p', { className: 'ax-label' }, c.label),
        React.createElement('h1', { className: 'ax-hero__h' }, c.h1),
        React.createElement('p', { className: 'ax-hero__deck' }, c.deck)
      ),
      React.createElement('div', { className: 'ax-container ax-cred' },
        React.createElement('div', { className: 'ax-cred__head' },
          React.createElement('p', { className: 'ax-label' }, b.label),
          React.createElement('h2', { className: 'ax-cred__h' }, b.h)
        ),
        React.createElement('div', { className: 'ax-cred__grid' },
          credCol(b.colA),
          credCol(b.colB)
        )
      )
    ...
    const dualitySection = React.createElement('section', { className: 'ax-duality', 'aria-labelledby': 'ax-duality-title', key: 'duality' },
      React.createElement('div', { className: 'ax-container' },
        ...
        React.createElement('h2', { className: 'ax-duality__h', id: 'ax-duality-title' }, 'Why I sit between two professional worlds.'),
        React.createElement('div', { className: 'ax-duality__band' },
          React.createElement('div', { className: 'ax-duality__side ax-duality__side--business' },
            React.createElement('p', { className: 'ax-duality__k' }, 'Business'),
            React.createElement('p', { className: 'ax-duality__s' }, 'I spent most of my career here.')
          ),
          React.createElement('img', { className: 'ax-duality__img', src: '/img/aggelos-overlap.webp?v=2', alt: 'Aggelos Mouzakitis', width: 250, height: 426, loading: 'lazy', decoding: 'async' }),
          React.createElement('div', { className: 'ax-duality__side ax-duality__side--psychology' },
            React.createElement('p', { className: 'ax-duality__k' }, 'Psychology'),
            React.createElement('p', { className: 'ax-duality__s' }, 'I trained here because business knowledge was not enough.')
          )
        ),
        React.createElement('div', { className: 'ax-explain' },
          React.createElement('p', { className: 'ax-explain__lead' }, 'Most problems I work on do not stay neatly on one side.'),
          React.createElement('div', { className: 'ax-explain__body' },
            React.createElement('p', null, 'A pricing problem can involve fear of rejection. A career decision can be commercially rational and psychologically difficult. A business can have the right strategy and an owner who keeps avoiding it.'),
            React.createElement('p', { className: 'is-strong' }, 'That is why I work with both.')
          )
        )
      )
    );
    // Dark: why I ended up here.
    const whySection = React.createElement('section', { className: 'ax-why', key: 'why' },
      React.createElement('div', { className: 'ax-container' },
        React.createElement('div', { className: 'ax-why__grid' },
          React.createElement('div', null,
            React.createElement('div', { className: 'ax-why__rule' }),
            React.createElement('h2', { className: 'ax-why__h' }, 'Why I ended up here')
          ),
          React.createElement('div', { className: 'ax-why__body' },
            ...
            React.createElement('p', null, "Knowing more about business did not explain why approval, fear or other people's reactions could still influence decisions that looked perfectly rational on paper. That gap is part of why I trained as a psychotherapist."),
            React.createElement('p', { className: 'ax-why__quote' }, 'Today I work with both sides of the problem when both sides matter.')
          )
        )
      )
    );
    ...
    const ctaSection = React.createElement('section', { className: 'ax-cta', key: 'cta' },
      React.createElement('div', { className: 'ax-container' },
        ...
        React.createElement('a', { className: 'ax-cta__btn', href: '/start-here/' }, 'Start here →')
      )
    );
    ...
    aboutMainChildren = [
      heroSection,
      credOrFact,
      React.createElement('section', { className: 'amx-dark amx-section', key: 'origin' },
        React.createElement('div', { className: 'amx-container amx-story-grid' },
          ...
          React.createElement('div', { className: 'amx-story-copy' },
            c.origin.map(function (p, i) { return React.createElement('p', { className: 'amx-body', key: i }, p); })
          )
        )
      ),
      React.createElement('section', { className: 'amx-paper amx-section', key: 'hw' },
        React.createElement('div', { className: 'amx-container' },
          ...
          React.createElement('div', { className: 'amx-reading-copy' },
            c.hw.map(function (p, i) { return React.createElement('p', { className: 'amx-body', key: i }, p); })
          )
        )
      ),
      React.createElement('section', { className: 'amx-dark amx-section', key: 'ex' },
        React.createElement('div', { className: 'amx-container' },
          React.createElement('div', { className: 'amx-section-head' },
          ...
          React.createElement('div', { className: 'amx-reading-copy' },
            c.ex.map(function (p, i) { return React.createElement('p', { className: 'amx-body', key: i }, p); })
          )
        )
      ),
      React.createElement('section', { className: 'amx-paper amx-section', key: 'or' },
        React.createElement('div', { className: 'amx-container' },
          React.createElement('div', { className: 'amx-section-head' },
          ...
          React.createElement('div', { className: 'amx-reading-copy' },
            c.or.map(function (p, i) { return React.createElement('p', { className: 'amx-body', key: i }, p); })
          )
        )
      ),
      React.createElement('section', { className: 'amx-dark amx-section amx-final', key: 'cta' },
        React.createElement('div', { className: 'amx-container' },
  ...
  return React.createElement(React.Fragment, null,
    ...
    React.createElement('main', { className: aboutMainClass }, aboutMainChildren),
    React.createElement(window.SiteFooterX, { lang })
  );
}
