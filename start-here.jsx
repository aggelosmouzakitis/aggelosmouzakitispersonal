...
function StartHereStyles() {
  var css = [
    ...
    '.sh-card__copy{font-size:clamp(20px,1.55vw,24px);line-height:1.28;font-weight:500;letter-spacing:-.01em;color:#171919}',
    // list rows (Flow A offers, Flow C tools)
    '.sh-list{display:flex;flex-direction:column;margin-top:4px}',
    '.sh-row{display:flex;align-items:center;justify-content:space-between;gap:24px;padding:22px 4px;border-top:1px solid rgba(24,26,28,.16);color:#171919;text-decoration:none;transition:color .15s,border-color .15s,padding-left .15s}',
    ...
    '.sh-row__desc{font-size:15px;line-height:1.5;color:#6A6F67}',
    ...
    '.sh-panel{background:#F3F0E8;border:1.5px solid rgba(24,26,28,.20);border-radius:8px;padding:26px 24px}',
    ...
    '.sh-btn--ghost{background:transparent;color:#171919;border-color:rgba(24,26,28,.30)}',
    '.sh-btn--ghost:hover{filter:none;border-color:#171919}',
