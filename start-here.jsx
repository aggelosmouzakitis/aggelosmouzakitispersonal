...
function StartHereStyles() {
  var css = [
    ...
    '.sh-row{display:flex;align-items:center;justify-content:space-between;gap:24px;padding:22px 4px;border-top:1px solid rgba(23,25,25,.16);color:#171919;text-decoration:none;transition:color .15s,border-color .15s,padding-left .15s}',
    '.sh-row:last-child{border-bottom:1px solid rgba(23,25,25,.16)}',
